...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2022 at 12:11 PM
...
(228, 'paystack_payment', 'off'),
(229, 'paystack_secret_key', ''),
...
(716, '', '', 'reviews', 'Reviews', '', '', 'Commentaires', 'Rezensionen', 'Отзывы', 'Comentarios', 'Yorumlar'),
...
(811, '', '', 'points_on_comment.', 'Points by posting a comment.', 'النقاط على التعليق.', 'Punten op commentaar.', 'Points sur le commentaire.', 'Punkte auf Kommentar.', 'Очки по комментарию.', 'Puntos sobre el comentario.', 'Yorumdaki noktalar.'),
(812, '', '', 'points_on_upload_new_song.', 'Points by uploading a song.', 'نقاط على تحميل أغنية جديدة.', 'Punten bij het uploaden van een nieuw nummer.', 'Points sur le téléchargement d\'une nouvelle chanson.', 'Punkte beim Hochladen eines neuen Songs.', 'Очки за загрузку новой песни.', 'Puntos por subir nueva canción.', 'Yeni şarkı yükleme puanları.'),
...
(814, '', '', 'points_on_like_some_one_track.', 'Points by liking a track.', 'نقاط على الإعجاب بمسار واحد.', 'Punten op het leuk vinden van een track.', 'Points sur aimer une piste.', 'Punkte, die einen Track mögen.', 'Указывает на то, что нравится какой-то трек.', 'Señala que le gusta alguna pista.', 'Bir parçayı beğenmeye dikkat edin.'),
...
(823, '', '', 'points_on_import_track.', 'Points by importing a song.', 'النقاط على مسار الاستيراد.', 'Punten op importspoor.', 'Points sur la piste d\'importation.', 'Punkte auf der Importspur.', 'Очки на импортном треке.', 'Puntos en pista de importación.', 'İçe aktarma yolundaki noktalar.'),
(824, '', '', 'points_on_user_update_his_profile_picture.', 'Points by updating your profile picture.', 'نقاط على المستخدم تحديث صورته الشخصية.', 'Punten waarop de gebruiker zijn profielfoto bijwerkt.', 'Les points sur l\'utilisateur mettent à jour sa photo de profil.', 'Punkte auf Benutzer aktualisieren sein Profilbild.', 'Очки на пользователя обновляют его изображение профиля.', 'Puntos en el usuario actualizan su foto de perfil.', 'Kullanıcı üzerindeki puanlar profil resmini günceller.'),
(825, '', '', 'points_on_purchase_track.', 'Points on purchasing a track.', 'النقاط على مسار الشراء.', 'Punten op aankoopspoor.', 'Points sur la piste d\'achat.', 'Punkte auf Kaufspur.', 'Очки на треке покупки.', 'Puntos en la pista de compra.', 'Satın alma yolundaki puanlar.'),
(826, '', '', 'points_on_user_go_pro.', 'Points by purchasing a PRO package.', 'النقاط على المستخدم GO PRO.', 'Punten op de gebruiker gaan PRO.', 'Les points sur l\'utilisateur vont PRO.', 'Punkte auf Benutzer gehen PRO.', 'Очки на пользователя становятся ПРО.', 'Los puntos en el usuario se vuelven PRO.', 'Kullanıcı üzerindeki puanlar PRO olur.'),
(827, '', '', 'points_on_review_some_one_track.', 'Points by reviewing a track.', 'نقاط على مراجعة بعض مسار واحد.', 'Punten op een overzicht van een track.', 'Points sur l\'examen d\'une piste.', 'Punkte bei der Überprüfung einer Spur.', 'Очки на просмотр какого-то одного трека.', 'Puntos al revisar alguna pista.', 'Bir parçayı gözden geçirme noktaları.'),
...
(844, '', '', '_your_address_has_been_added_successfully_', 'Your address has been added successfully!', 'تم إضافة عنوانك بنجاح!', 'Uw adres is succesvol toegevoegd!', 'Votre adresse a été ajoutée avec succès!', 'Ihre Adresse wurde erfolgreich hinzugefügt!', 'Ваш адрес был успешно добавлен!', '¡Su dirección se ha agregado con éxito!', 'Adresiniz başarıyla eklendi!'),
(845, '', '', '_your_address_has_been_edited_successfully_', 'Your address has been edited successfully!', 'تم تحرير عنوانك بنجاح!', 'Uw adres is succesvol bewerkt!', 'Votre adresse a été modifiée avec succès!', 'Ihre Adresse wurde erfolgreich bearbeitet!', 'Ваш адрес был успешно отредактирован!', '¡Su dirección ha sido editada con éxito!', 'Adresiniz başarıyla düzenlendi!'),
...
(847, '', '', '_the_url_is_invalid._please_enter_a_valid_url_', 'The URL is invalid, Please enter a valid URL.', 'عنوان URL غير صالح، يرجى إدخال عنوان URL صالح.', 'De URL is ongeldig, voer een geldige URL in.', 'L\'URL n\'est pas valide, veuillez entrer une URL valide.', 'Die URL ist ungültig, bitte geben Sie eine gültige URL ein.', 'URL-адрес недействителен, введите действительный URL.', 'La URL no es válida, ingrese una URL válida.', 'URL geçersiz, lütfen geçerli bir URL girin.'),
(848, '', '', '_media_file_is_invalid._please_select_a_valid_image___video_', 'Media file is invalid, Please select a valid image / video.', 'ملف الوسائط غير صالح، يرجى تحديد صورة صالحة / فيديو صالحة.', 'Mediabestand is ongeldig, selecteer een geldige afbeelding / video.', 'Le fichier multimédia n\'est pas valide, sélectionnez une image / vidéo valide.', 'Die Mediendatei ist ungültig, bitte wählen Sie ein gültiges Bild / Video aus.', 'Медиа-файл недействителен, выберите действительное изображение / видео.', 'El archivo multimedia no es válido, seleccione una imagen / video válida.', 'Medya dosyası geçersiz, lütfen geçerli bir resim / video seçin.'),
(849, '', '', '_media_file_is_invalid._please_select_a_valid_image_', 'Media file is invalid, Please select a valid image.', 'ملف الوسائط غير صالح، يرجى تحديد صورة صالحة.', 'Mediabestand is ongeldig, selecteer een geldige afbeelding.', 'Le fichier multimédia n\'est pas valide, sélectionnez une image valide.', 'Die Mediendatei ist ungültig, bitte wählen Sie ein gültiges Bild aus.', 'Media File недействителен, выберите действительное изображение.', 'El archivo de medios no es válido, seleccione una imagen válida.', 'Medya dosyası geçersiz, lütfen geçerli bir görüntü seçin.'),
(850, '', '', '_media_file_is_invalid._please_select_a_valid_audio_', 'Media file is invalid, Please select a valid audio file.', 'ملف الوسائط غير صالح، يرجى تحديد ملف صوتي صالح.', 'Mediabestand is ongeldig, selecteer een geldig audiobestand.', 'Le fichier multimédia n\'est pas valide, veuillez sélectionner un fichier audio valide.', 'Die Mediendatei ist ungültig, bitte wählen Sie eine gültige Audiodatei aus.', 'Media File недействителен, выберите действительный аудиофайл.', 'El archivo de medios no es válido, seleccione un archivo de audio válido.', 'Medya dosyası geçersiz, lütfen geçerli bir ses dosyası seçin.'),
(851, '', '', '_too_many_login_attempts_please_try_again_later_', 'Too many login attempts, please try again later.', 'الكثير من محاولات تسجيل الدخول، يرجى المحاولة مرة أخرى لاحقا.', 'Te veel inlogpogingen, probeer het later opnieuw.', 'Trop de tentatives de connexion, veuillez réessayer plus tard.', 'Zu viele Login-Versuche, bitte versuchen Sie es später erneut.', 'Слишком много попыток входа в систему, пожалуйста, попробуйте позже.', 'Demasiados intentos de inicio de sesión, inténtalo de nuevo más tarde.', 'Çok fazla giriş denemesi, lütfen daha sonra tekrar deneyin.'),
(852, '', '', '_url_can_not_be_empty_', 'URL can not be empty.', 'عنوان URL لا يمكن أن يكون فارغا.', 'URL kan niet leeg zijn.', 'L\'URL ne peut pas être vide.', 'URL kann nicht leer sein.', 'URL не может быть пустым.', 'URL no puede estar vacío.', 'URL boş olamaz.'),
(853, '', '', '_address_can_not_be_empty_', 'Address can not be empty.', 'العنوان لا يمكن أن تكون فارغة.', 'Adres kan niet leeg zijn.', 'L\'adresse ne peut pas être vide.', 'Adresse kann nicht leer sein.', 'Адрес не может быть пустым.', 'La dirección no puede estar vacía.', 'Adres boş olamaz.'),
(854, '', '', '_tickets_available_and_ticket_price_can_not_be_empty_', 'Tickets availability and Price can\'t be empty.', 'لا يمكن أن يكون توافر التذاكر والسعر فارغا.', 'Tickets Beschikbaarheid en prijs kan niet leeg zijn.', 'Billets Disponibilité et prix ne peuvent pas être vides.', 'Tickets Verfügbarkeit und Preis kann nicht leer sein.', 'Наличие и цены на билеты не могут быть пустыми.', 'Las boletos La disponibilidad y el precio no pueden estar vacíos.', 'Biletler kullanılabilirliği ve fiyat boş olamaz.'),
(855, '', '', '_event_cover_can_not_be_empty_', 'Event Cover is required.', 'غطاء الحدث مطلوب.', 'Evenementbedekking is vereist.', 'La couverture d\'événement est requise.', 'Ereignisdeckel ist erforderlich.', 'Обложка событий требуется.', 'Se requiere la cubierta de eventos.', 'Olay kapağı gereklidir.'),
(856, '', '', '_event_video_can_not_be_empty_', 'Event Video is required.', 'مقطع الفيديو الحدث مطلوب.', 'Evenement-video is vereist.', 'La vidéo d\'événement est requise.', 'Ereignisvideo ist erforderlich.', 'Требуется видео события.', 'Se requiere video de evento.', 'Olay videosu gereklidir.'),
(857, '', '', '_your_event_has_been_published_successfully_', 'Your event has been published successfully!', 'تم نشر حدثك بنجاح!', 'Uw evenement is succesvol gepubliceerd!', 'Votre événement a été publié avec succès!', 'Ihre Veranstaltung wurde erfolgreich veröffentlicht!', 'Ваше мероприятие было опубликовано успешно!', 'Su evento ha sido publicado con éxito!', 'Etkinliğiniz başarıyla yayınlandı!'),
(858, '', '', '_your_event_has_been_updated_successfully_', 'Your event has been updated successfully!', 'تم تحديث الحدث الخاص بك بنجاح!', 'Uw evenement is succesvol bijgewerkt!', 'Votre événement a été mis à jour avec succès!', 'Ihre Veranstaltung wurde erfolgreich aktualisiert!', 'Ваше мероприятие было успешно обновлено!', '¡Su evento ha sido actualizado con éxito!', 'Etkinliğiniz başarıyla güncellendi!'),
(859, '', '', '_payment_successfully_done_', 'Payment successfully, Thank you!', 'الدفع بنجاح، شكرا لك!', 'Betaling succesvol, dank u!', 'Paiement avec succès, merci!', 'Zahlung erfolgreich, danke!', 'Оплата успешно, спасибо!', 'Pago con éxito, gracias!', 'Ödeme başarıyla, teşekkür ederim!'),
(860, '', '', '_please_select_a_song_', 'Please select a song.', 'يرجى اختيار أغنية.', 'Selecteer een nummer.', 'Veuillez sélectionner une chanson.', 'Bitte wählen Sie ein Lied aus.', 'Пожалуйста, выберите песню.', 'Por favor, seleccione una canción.', 'Lütfen bir şarkı seçin.'),
(861, '', '', '_please_select_a_valid_image_', 'Please select a valid image.', 'يرجى تحديد صورة صالحة.', 'Selecteer een geldige afbeelding.', 'Veuillez sélectionner une image valide.', 'Bitte wählen Sie ein gültiges Bild aus.', 'Пожалуйста, выберите действительное изображение.', 'Por favor, seleccione una imagen válida.', 'Lütfen geçerli bir görüntü seçin.'),
(862, '', '', '_your_product_has_been_published_successfully_', 'Your product has been published successfully!', 'تم نشر منتجك بنجاح!', 'Uw product is succesvol gepubliceerd!', 'Votre produit a été publié avec succès!', 'Ihr Produkt wurde erfolgreich veröffentlicht!', 'Ваш продукт был успешно опубликован!', '¡Su producto ha sido publicado con éxito!', 'Ürününüz başarılı bir şekilde yayınlandı!'),
(863, '', '', '_your_product_is_under_review_', 'Your product is submitted and will be reviewed soon.', 'يتم تقديم منتجك وسيتم مراجعته قريبا.', 'Uw product wordt ingediend en wordt binnenkort beoordeeld.', 'Votre produit est soumis et sera revu bientôt.', 'Ihr Produkt wird eingereicht und wird bald überprüft.', 'Ваш продукт отправлен и будет рассмотрен в ближайшее время.', 'Su producto se envía y será revisado pronto.', 'Ürününüz gönderilir ve yakında gözden geçirilecektir.'),
(864, '', '', '_your_product_has_been_edited_successfully_', 'Your product has been edited successfully!', 'تم تحرير منتجك بنجاح!', 'Uw product is succesvol bewerkt!', 'Votre produit a été édité avec succès!', 'Ihr Produkt wurde erfolgreich bearbeitet!', 'Ваш продукт был успешно отредактирован!', '¡Su producto ha sido editado con éxito!', 'Ürününüz başarıyla düzenlendi!'),
(865, '', '', '_some_products_don_t_have_enough_of_units_', 'Some of your products don\'t have enough units.', 'بعض منتجاتك ليس لديها وحدات كافية.', 'Sommige van uw producten hebben niet genoeg eenheden.', 'Certains de vos produits n\'ont pas assez d\'unités.', 'Einige Ihrer Produkte haben nicht genügend Einheiten.', 'Некоторые из ваших продуктов не имеют достаточностей.', 'Algunos de sus productos no tienen suficientes unidades.', 'Ürünlerinizin bazılarının yeterli birim yok.'),
(866, '', '', '_you_don_t_have_enough_wallet_', 'You don\'t have enough balance in your wallet.', 'ليس لديك رصيد كاف في محفظتك.', 'Je hebt niet genoeg balans in je portemonnee.', 'Vous n\'avez pas assez d\'équilibre dans votre portefeuille.', 'Sie haben nicht genug Gleichgewicht in Ihrer Brieftasche.', 'У вас недостаточно баланса в вашем кошельке.', 'No tienes suficiente equilibrio en tu billetera.', 'Cüzdanında yeterince dengeniz yok.'),
(867, '', '', '_please_top_up_your_wallet_', 'Please top up your wallet', 'يرجى تباريز محفظتك', 'Vul uw portemonnee bij', 'S\'il vous plaît recharger votre portefeuille', 'Bitte tippen Sie Ihre Brieftasche auf', 'Пожалуйста, пополните свой кошелек', 'Por favor, recargue su billetera', 'Lütfen cüzdanını doldur'),
(868, '', '', '_your_order_has_been_placed_successfully_', 'Your order has been placed!', 'وقد وضعت طلبك!', 'Uw bestelling is geplaatst!', 'Votre commande a été enregistrée!', 'Deine Bestellung wurde aufgenommen!', 'Ваш заказ был размещен!', '¡Su orden ha sido puesta!', 'Siparişiniz alındı!'),
(869, '', '', '_tracking_info_has_been_saved_successfully_', 'Tracking info has been saved.', 'تم حفظ معلومات التتبع.', 'Tracking-informatie is opgeslagen.', 'Les informations de suivi ont été enregistrées.', 'Tracking-Info wurde gespeichert.', 'Информация о отслеживании была сохранена.', 'La información de seguimiento se ha guardado.', 'İzleme bilgisi kaydedildi.'),
(870, '', '', '_review_has_been_sent_successfully_', 'Review has been sent.', 'تم إرسال المراجعة.', 'Beoordeling is verzonden.', 'L\'examen a été envoyé.', 'Überprüfung wurde gesendet.', 'Обзор был отправлен.', 'Revisión ha sido enviada.', 'İnceleme gönderildi.'),
(871, '', '', '_your_request_is_under_review_', 'Your request is under review.', 'طلبك قيد المراجعة.', 'Uw aanvraag wordt beoordeeld.', 'Votre demande est à l\'étude.', 'Ihre Anfrage ist überprüft.', 'Ваш запрос находится под контролем.', 'Su solicitud está bajo revisión.', 'İsteğiniz inceleme altında.'),
(872, '', '', '_your_story_has_been_published_successfully_', 'Your story has been published successfully!', 'تم نشر قصتك بنجاح!', 'Je verhaal is succesvol gepubliceerd!', 'Votre histoire a été publiée avec succès!', 'Ihre Geschichte wurde erfolgreich veröffentlicht!', 'Ваша история была успешно опубликована!', 'Tu historia ha sido publicada con éxito!', 'Hikayen başarılı bir şekilde yayınlandı!'),
(873, '', '', '_your_story_has_been_uploaded_successfully_to_publish_it_please_pay_', 'Your story has been uploaded, please pay to continue.', 'تم تحميل قصتك، يرجى الدفع للمتابعة.', 'Uw verhaal is geüpload, betaal alstublieft om door te gaan.', 'Votre histoire a été téléchargée, veuillez payer pour continuer.', 'Ihre Geschichte wurde hochgeladen, bitte zahlen Sie, um fortzufahren.', 'Ваша история была загружена, пожалуйста, оплатите, чтобы продолжить.', 'Su historia ha sido cargada, por favor pague para continuar.', 'Hikayen yüklendi, lütfen devam etmek için ödeme yapın.'),
(874, '', '', '_story_not_found_or_its_active_', 'Story not found or not active.', 'قصة غير موجودة أو غير نشطة.', 'Verhaal niet gevonden of niet actief.', 'Histoire non trouvée ou non active.', 'Geschichte nicht gefunden oder nicht aktiv.', 'История не найдена или не активна.', 'Historia no encontrada o no activa.', 'Hikaye bulunamadı ya da aktif değil.'),
(875, '', '', '_you_don_t_have_enough_money_please_top_up_your_wallet_', 'You don\'t have enough balance in your wallet, please top up your wallet.', 'ليس لديك رصيد كاف في محفظتك، يرجى تباريز محفظتك.', 'Je hebt niet genoeg balans in je portemonnee, vul je portemonnee aan.', 'Vous n\'avez pas assez d\'équilibre dans votre portefeuille, veuillez recharger votre portefeuille.', 'Sie haben nicht genug Gleichgewicht in Ihrer Brieftasche, bitte tippen Sie bitte Ihre Brieftasche auf.', 'У вас не хватает баланса в вашем кошельке, пожалуйста, пополните свой кошелек.', 'No tiene suficiente equilibrio en su billetera, por favor recargue su billetera.', 'Cüzdanınızda yeterli dengeniz yok, lütfen cüzdanınızı doldurun.'),
(876, '', '', 'login_with_linkedin', 'Login with LinkedIn', 'تسجيل الدخول مع ينكدين', 'Log in met LinkedIn', 'Se connecter avec LinkedIn', 'Login mit LinkedIn', 'Войти с linkedin.', 'Ingresar con LinkedIn', 'Linkedln ile giriş yap'),
(877, '', '', 'login_with_vkontakte', 'Login with Vkontakte', 'تسجيل الدخول مع vkontakte.', 'Log in met VKONTAKTE', 'Connectez-vous avec vkontakte', 'Melden Sie sich mit VKONTAKTE an', 'Войти с Вконтакте', 'Inicia sesión con vkontakte', 'VKontakte ile giriş yapın'),
(878, '', '', 'login_with_instagram', 'Login with Instagram', 'تسجيل الدخول مع Instagram.', 'Log in met Instagram', 'Connectez-vous avec Instagram', 'Melden Sie sich mit Instagram an', 'Войти с Instagram.', 'Inicia sesión con Instagram', 'Instagram ile giriş yapmak'),
(879, '', '', 'login_with_qq', 'Login with QQ', 'تسجيل الدخول مع QQ.', 'Login met QQ', 'Connectez-vous avec QQ', 'Login mit QQ.', 'Войти с помощью QQ', 'Inicia sesión con QQ', 'QQ ile giriş yapın'),
(880, '', '', 'login_with_wechat', 'Login with WeChat', 'تسجيل الدخول مع wechat.', 'Login met Wechat', 'Connectez-vous avec wechat', 'Login mit WECHAT', 'Войти с wechat.', 'Inicia sesión con WeChat', 'Wechat ile giriş yapın'),
(881, '', '', 'login_with_discord', 'Login with Discord', 'تسجيل الدخول مع الخلاف', 'Inloggen met Discord', 'Connectez-vous avec la discorde', 'Login mit der Zwietracht', 'Войти с раздортом', 'Iniciar sesión con la discordia', 'Uyumlulukla giriş yapın'),
(882, '', '', 'login_with_mailru', 'Login with Mailru', 'تسجيل الدخول مع mailru.', 'Login met MailRU', 'Connectez-vous avec Mailru', 'Melden Sie sich mit MailRU an', 'Войти с MailRu', 'Inicia sesión con mailru', 'Mailru ile giriş yapın'),
(883, '', '', 'no_items_found', 'No items found.', 'لم يتم العثور على العناصر.', 'Geen items gevonden.', 'Aucun élément trouvé.', 'Keine Elemente gefunden.', 'Ничего не найдено.', 'No se encontraron artículos.', 'Hiç bir öğe bulunamadı.'),
(884, '', '', 'you_don_t_have_enough_wallet', 'You don\'t have enough balance in your wallet.', 'ليس لديك رصيد كاف في محفظتك.', 'Je hebt niet genoeg balans in je portemonnee.', 'Vous n\'avez pas assez d\'équilibre dans votre portefeuille.', 'Sie haben nicht genug Gleichgewicht in Ihrer Brieftasche.', 'У вас недостаточно баланса в вашем кошельке.', 'No tienes suficiente equilibrio en tu billetera.', 'Cüzdanında yeterince dengeniz yok.'),
(885, '', '', 'please_top_up_your_wallet', 'Please top up your wallet.', 'يرجى تباريز محفظتك.', 'Vul uw portemonnee bij.', 'S\'il vous plaît recharper votre portefeuille.', 'Bitte tippen Sie Ihre Brieftasche auf.', 'Пожалуйста, пополните свой кошелек.', 'Por favor, recargue su billetera.', 'Lütfen cüzdanınızı doldurun.'),
(886, '', '', 'total', 'Total', 'المجموع', 'Totaal', 'Le total', 'Gesamt', 'Общий', 'Total', 'Toplam'),
(887, '', '', 'add_new_address', 'Add New Address', 'إضافة عنوان جديد', 'Nieuw adres toevoegen', 'Ajouter une nouvelle adresse', 'Neue Adresse hinzufügen', 'Добавьте новый адрес', 'Agregar nueva dirección', 'Yeni adres ekleyin'),
(888, '', '', 'create_new_event', 'Create New Event', 'إنشاء حدث جديد', 'Maak een nieuw evenement', 'Créer un nouvel événement', 'Neue Ereignis erstellen.', 'Создать новое событие', 'Crear nuevo evento', 'Yeni Etkinlik Oluştur'),
(889, '', '', 'manage_events', 'Manage Events', 'إدارة الأحداث', 'Beheer evenementen', 'Gérer les événements', 'Events verwalten', 'Управление событиями', 'Gestionar eventos', 'Olayları yönet'),
(890, '', '', 'browse_events', 'Browse Events', 'تصفح الأحداث', 'Blader door evenementen', 'Parcourir les événements', 'Events durchsuchen', 'Просматривать события', 'Navegar eventos', 'Etkinliklere göz atın'),
(891, '', '', 'joined_events', 'Joined Events', 'انضم الأحداث', 'Gesloten evenementen', 'Événements mariés', 'Events beigetreten.', 'Присоединились события', 'Eventos unidos', 'Katıldı Etkinlikler'),
(892, '', '', 'view_purchased_tickets', 'View Purchased Tickets', 'عرض التذاكر المشتراة', 'Bekijk gekochte tickets', 'Voir les billets achetés', 'Kaufgekaufte Tickets anzeigen.', 'Просмотр приобретенных билетов', 'Ver boletos comprados', 'Satın alınan biletleri görüntüle'),
(893, '', '', 'event_name', 'Event Name', 'اسم الحدث', 'Evenement naam', 'Nom de l\'événement', 'Veranstaltungsname', 'Название события', 'Nombre del evento', 'Etkinlik adı'),
(894, '', '', 'event_location', 'Event location', 'موقع الحدث', 'Evenementlocatie', 'Lieu de l\'événement', 'Veranstaltungsort', 'Мероприятие Местонахождение', 'Lugar del evento', 'Olay yeri'),
(895, '', '', 'online', 'Online', 'متصل', 'Online', 'En ligne', 'Online', 'онлайн', 'En línea', 'İnternet üzerinden'),
(896, '', '', 'real_location', 'Real Location', 'الموقع الحقيقي', 'Echte locatie', 'Emplacement réel', 'Echter Ort.', 'Реальное расположение', 'Ubicación real', 'Gerçek yer'),
(897, '', '', 'event_start_date', 'Event Start Date', 'تاريخ بدء الحدث', 'Evenement startdatum', 'Date de début de l\'événement', 'Event-Startdatum', 'Дата начала события', 'Fecha de inicio del evento', 'Olay Başlangıç ​​Tarihi'),
(898, '', '', 'event_start_time', 'Event Start Time', 'وقت بدء الوقت', 'Evenement starttijd', 'Heure de début de l\'événement', 'Event-Startzeit.', 'Время начала события', 'Tiempo de inicio del evento', 'Olay başlangıç ​​zamanı'),
(899, '', '', 'event_end_date', 'Event End Date', 'تاريخ انتهاء الحدث', 'Evenement-einddatum', 'Date de fin d\'événement', 'Ereignis-Enddatum', 'Дата окончания событий', 'Fecha de finalización del evento', 'Etkinlik Sonu'),
(900, '', '', 'event_end_time', 'Event End Time', 'نهاية الوقت الوقت', 'Etentijd', 'Temps de fin d\'événement', 'Ereignis-Endzeit.', 'Время окончания событий', 'Evento final de tiempo', 'Etkinlik Sonu'),
(901, '', '', 'timezone', 'Timezone', 'وحدة زمنية', 'Tijdzone', 'Fuseau horaire', 'Zeitzone', 'Часовой пояс', 'Zona horaria', 'Saat dilimi'),
(902, '', '', 'sell_tickets', 'Sell Tickets', 'بيع تذاكر', 'Verkoop tickets', 'Vendre des tickets', 'Tickets verkaufen', 'Продавать билеты', 'Venta de entradas', 'Bilet satmak'),
(903, '', '', 'tickets_available_total_tickets_available_for_this_event_', 'Tickets available (Total tickets available for this event)', 'التذاكر المتاحة (إجمالي التذاكر المتاحة لهذا الحدث)', 'Tickets beschikbaar (totale tickets beschikbaar voor dit evenement)', 'Billets disponibles (Total des billets disponibles pour cet événement)', 'Verfügbare Tickets (Gesamtkarten für diese Veranstaltung)', 'Доступны билеты (общие билеты доступны для этого мероприятия)', 'Entradas disponibles (Total Boletos disponibles para este evento)', 'Biletler mevcut (bu etkinlik için mevcut toplam bilet)'),
(904, '', '', 'ticket_price', 'Ticket Price', 'سعر التذكرة', 'Ticket prijs', 'Prix ​​du billet', 'Ticket Preis', 'Стоимость билета', 'Precio de venta', 'Bilet fiyatı'),
(905, '', '', 'event_description', 'Event Description', 'وصف الحدث', 'beschrijving van het evenement', 'description de l\'évenement', 'Eventbeschreibung', 'Описание события', 'descripción del evento', 'Etkinlik Açıklaması'),
(906, '', '', 'event_cover', 'Event Cover', 'غطاء الحدث', 'Gebeurtenisdekking', 'Couverture d\'événement', 'Event Cover', 'Обложка события', 'Portada de eventos', 'Olay kapağı'),
(907, '', '', 'event_video_trailer', 'Event Video/Trailer', 'فيديو فيديو / مقطورة', 'Evenement Video / Trailer', 'Vidéo d\'événement / remorque', 'Ereignisvideo / Anhänger', 'Видео события / трейлер', 'Evento Video / Trailer', 'Olay Video / Treyler'),
(908, '', '', 'create_product', 'Create Product', 'إنشاء المنتج', 'Maak product', 'Créer un produit', 'Produkt erstellen', 'Создать продукт', 'Crear producto', 'Ürün oluştur'),
(909, '', '', 'manage_products', 'Manage Products', 'إدارة المنتجات', 'Producten beheren', 'Gérer les produits', 'Produkte verwalten', 'Управление продуктами', 'Gestionar productos', 'Ürünleri yönet'),
(910, '', '', 'total_item_units', 'Total Item Units', 'وحدات البند الإجمالية', 'Totale itemeenheden', 'Total des unités d\'article', 'Gesamtstückeinheiten', 'Всего единиц товара', 'Unidades de elementos totales', 'Toplam Ürün Birimleri'),
(911, '', '', 'related_to_song', 'Related to song', 'المتعلقة الأغنية', 'Gerelateerd aan liedje', 'Liée à la chanson', 'Im Zusammenhang mit Song.', 'Связанные с песней', 'Relacionado con la canción', 'Şarkı ile ilgili'),
(912, '', '', 'images', 'Images', 'صور', 'Afbeeldingen', 'Images', 'Bilde', 'Изображений', 'Imágenes', 'Görüntüler'),
(913, '', '', 'who_can_see', 'Who can see', 'من يستطيع رؤيته', 'Wie kan zien', 'Qui peut voir', 'Wer kann sehen?', 'Кто может видеть', 'Quien puede ver', 'Kim görebilir'),
(914, '', '', 'show_to_my_followers_only', 'Show To My Followers', 'عرض لأتببي', 'Toon aan mijn volgers', 'Montrer à mes adeptes', 'Zeigen Sie meinen Anhängern', 'Показать моим последователям', 'Mostrar a mis seguidores', 'Takipçilerime göster'),
(915, '', '', 'show_to_all_users', 'Show To All Users (Promotion)', 'عرض لجميع المستخدمين (الترويج)', 'Toon aan alle gebruikers (promotie)', 'Montrer à tous les utilisateurs (Promotion)', 'Alle Benutzer anzeigen (Promotion)', 'Показать всем пользователям (продвижение)', 'Mostrar a todos los usuarios (promoción)', 'Tüm kullanıcılara göster (Promosyon)'),
(916, '', '', 'story_image', 'Story Image', 'قصة صورة', 'Verhaalbeeld', 'Image de l\'histoire', 'Geschichten-Image', 'История истории', 'Imagen de la historia', 'Hikaye resmi'),
(917, '', '', 'upload_song', 'Upload Song', 'تحميل الأغنية', 'Upload Song', 'Chant de téléchargement', 'Song hochladen', 'Загрузить песню', 'Cargar canción', 'Şarkı yükle'),
(918, '', '', 'shipped', 'Shipped', 'شحنها', 'Verzenden', 'Expédié', 'Geliefert', 'Отправленный', 'Enviado', 'Sevk edilen'),
(919, '', '', 'delivered', 'Delivered', 'تم التوصيل', 'Afgeleverd', 'Livré', 'Geliefert', 'Доставленный', 'Entregado', 'Teslim edilmiş'),
(920, '', '', 'payments', 'Payments', 'المدفوعات', 'Betalingen', 'Paiements', 'Zahlungen', 'Платежи', 'Pagos', 'Ödeme'),
(921, '', '', 'subtotal', 'Subtotal', 'فرعي', 'Subtotaal', 'Total', 'Zwischensumme', 'Промежуточный итог', 'Total parcial', 'ara toplam'),
(922, '', '', 'refund_money', 'Refund Money', 'استرداد المال', 'Restitutie geld', 'Remboursement de l\'argent', 'Rückerstattung von Geld', 'Возвращать деньги', 'Reembolsar dinero', 'Para iadesi'),
(923, '', '', 'tracking_details', 'Tracking Details', 'تتبع التفاصيل', 'Tracking details', 'Détails de suivi', 'Verfolgungsdetails', 'Отслеживание деталей', 'Detalles de seguimiento', 'Yürüyüş detayları'),
(924, '', '', 'site_url', 'Site Url', 'URL الموقع', 'Site URL', 'URL du site', 'Seiten-URL', 'Адрес сайта', 'Sitio URL', 'Site URL\'si'),
(925, '', '', 'tracking_number', 'Tracking Number', 'رقم التعقب', 'Volg nummer', 'Numéro de suivi', 'Auftragsnummer, Frachtnummer, Sendungscode', 'Номер Отслеживания', 'El número de rastreo', 'Takip numarası'),
(926, '', '', 'delivery_address', 'Delivery Address', 'عنوان التسليم', 'Bezorgadres', 'Adresse de livraison', 'Lieferadresse', 'Адрес доставки', 'Dirección de entrega', 'Teslimat adresi'),
(927, '', '', 'no_orders_found', 'No orders found', 'لم يتم العثور على أية طلبات', 'Geen bestellingen gevonden', 'Aucune commande trouvée', 'Keine Bestellungen gefunden', 'Заказы не найдены', 'No se han encontrado pedidos', 'sipariş bulunamadı'),
(928, '', '', 'products', 'Products', 'منتجات', 'Producten', 'Des produits', 'Produkte', 'Продукты', 'Productos', 'Ürün:% s'),
(929, '', '', 'view_details', 'View Details', 'عرض التفاصيل', 'Bekijk details', 'Voir les détails', 'Details anzeigen', 'Посмотреть детали', 'Ver detalles', 'Detayları göster'),
(930, '', '', 'stories', 'Stories', 'قصص', 'Verhalen', 'Histoires', 'Geschichten', 'Истории', 'Cuentos', 'Öyküler'),
(931, '', '', 'joined', 'Joined', 'انضم', 'Toegetreden', 'Rejoint', 'Trat bei', 'Присоединился', 'Unido', 'Katılmış'),
(932, '', '', 'join', 'Join', 'انضم', 'Meedoen', 'Rejoindre', 'Verbinden', 'Присоединиться', 'Entrar', 'Katılmak'),
(933, '', '', 'buy_a_ticket', 'Buy a ticket', 'شراء تذكرة', 'Koop een kaartje', 'Acheter un ticket', 'Kauf ein Ticket', 'Купить билет', 'Comprar un boleto', 'Bilet satın al'),
(934, '', '', 'view_trailer', 'View Trailer', 'عرض مقطورة', 'Bekijken', 'Voir la remorque', 'Anhänger anzeigen.', 'Просмотр трейлера', 'Vista del remolque', 'Römork görmek'),
(935, '', '', 'edit_event', 'Edit Event', 'تحرير الحدث', 'Bewerkingsgebeurtenis', 'Édition', 'Event bearbeiten.', 'Редактировать событие', 'Editar evento', 'Etkinliği düzenle'),
(936, '', '', 'start_date', 'Start date', 'تاريخ البدء', 'Startdatum', 'Date de début', 'Startdatum', 'Дата начала', 'Fecha de inicio', 'Başlangıç ​​tarihi'),
(937, '', '', 'end_date', 'End date', 'تاريخ الانتهاء', 'Einddatum', 'Date de fin', 'Endtermin', 'Дата окончания', 'Fecha final', 'Bitiş tarihi'),
(938, '', '', 'available_tickets', 'Available Tickets', 'التذاكر المتاحة', 'Beschikbare tickets', 'Billets disponibles', 'Verfügbare Tickets', 'Доступные билеты', 'Entradas disponibles', 'Mevcut Biletler'),
(939, '', '', 'joined_people', 'Joined people', 'انضم الناس', 'Kwam bij mensen', 'Rejoint les gens', 'Menschen beigetreten.', 'Присоединились к людям', 'Se unió a las personas', 'Katıldı insanlar'),
(940, '', '', 'location', 'Location', 'موقع', 'Plaats', 'Emplacement', 'Standort', 'Место нахождения', 'Localización', 'Konum'),
(941, '', '', 'total_events', 'Total Events', 'إجمالي الأحداث', 'Totaal evenementen', 'Événements total', 'Gesamtereignisse', 'Всего мероприятия', 'Eventos totales', 'Toplam olaylar'),
(942, '', '', 'total_joined_users', 'Total Joined Users', 'إجمالي مستودع المستخدمين', 'Totaal toegevoegde gebruikers', 'Total des utilisateurs joints', 'Gesamtzahl beigetretenen Benutzern.', 'Всего соединенных пользователей', 'Usuarios totales unidos', 'Toplam Katılan Kullanıcılar'),
(943, '', '', 'total_available_tickets', 'Total Available Tickets', 'إجمالي التذاكر المتاحة', 'Totaal beschikbare tickets', 'Total des billets disponibles', 'Gesamt verfügbare Tickets.', 'Всего доступных билетов', 'Tickets totales disponibles', 'Toplam Mevcut Biletler'),
(944, '', '', 'most_joined_events', 'Most joined events', 'الأكثر انضمام الأحداث', 'Meest gevonden evenementen', 'Les événements les plus rejoints', 'Die meisten zusammengeschlossenen Ereignisse.', 'Большинство присоединившихся событий', 'Eventos más unidos', 'En Çok Katılan Etkinlikler'),
(945, '', '', 'most_sold_events', 'Most sold events', 'الأحداث الأكثر مبيعا', 'Meest verkochte evenementen', 'Événements les plus vendus', 'Die meisten verkauften Events.', 'Самые проданные события', 'Los eventos más vendidos', 'En çok satılan etkinlikler'),
(946, '', '', 'no_more_events_found', 'No more events found', 'لم يتم العثور على المزيد من الأحداث', 'Geen evenementen meer gevonden', 'Plus d\'événements trouvés', 'Keine Ereignisse mehr gefunden', 'Больше не найдено событий', 'No más eventos encontrados', 'Artık etkinlik bulunamadı'),
(947, '', '', 'no_more_tickets_found', 'No more tickets found', 'لم يتم العثور على المزيد من التذاكر', 'Geen tickets meer gevonden', 'Plus de billets trouvés', 'Keine Tickets mehr gefunden', 'Больше не найдено билетов', 'No más boletos encontrados', 'Daha fazla bilet bulunamadı'),
(948, '', '', 'no_more_products_found', 'No more products found', 'لم يتم العثور على المزيد من المنتجات', 'Geen producten gevonden', 'Plus de produits trouvés', 'Keine Produkte mehr gefunden', 'Больше не найдено продуктов', 'No se encontraron más productos.', 'Daha fazla ürün bulunamadı'),
(949, '', '', 'no_more_reviews_found', 'No more reviews found', 'لم يتم العثور على المزيد من المراجعات', 'Geen beoordelingen gevonden', 'Pas de nouvelles critiques trouvées', 'Keine mehr Bewertungen mehr gefunden', 'Больше не найдено больше отзывов', 'No se encontraron más opiniones.', 'Daha fazla yorum bulunamadı'),
(950, '', '', 'payment_successfully_done', 'payment successfully done', 'دفع بنجاح', 'Betaling succesvol gedaan', 'Paiement effectué avec succès', 'Zahlung erfolgreich erledigt', 'Оплата успешно сделана', 'Pago realizado con éxito', 'Ödeme başarıyla yapıldı'),
(951, '', '', 'are_you_sure_you_want_to_pay_to_buy_song_', 'Are you sure you want to pay to buy this song?', 'هل أنت متأكد أنك تريد أن تدفع لشراء هذه الأغنية؟', 'Weet je zeker dat je wilt betalen om dit nummer te kopen?', 'Êtes-vous sûr de vouloir payer pour acheter cette chanson?', 'Möchten Sie sicher, dass Sie diesen Song kaufen möchten?', 'Вы уверены, что хотите заплатить, чтобы купить эту песню?', '¿Estás seguro de que quieres pagar para comprar esta canción?', 'Bu şarkıyı satın almak için ödemek istediğinize emin misiniz?'),
(952, '', '', 'are_you_sure_you_want_to_pay_to_buy_album_', 'Are you sure you want to pay to buy this album?', 'هل أنت متأكد أنك تريد أن تدفع لشراء هذا الألبوم؟', 'Weet je zeker dat je wilt betalen om dit album te kopen?', 'Êtes-vous sûr de vouloir payer pour acheter cet album?', 'Möchten Sie sicher, dass Sie dieses Album kaufen möchten?', 'Вы уверены, что хотите заплатить, чтобы купить этот альбом?', '¿Estás seguro de que quieres pagar para comprar este álbum?', 'Bu albümü satın almak için ödemek istediğinize emin misiniz?'),
(953, '', '', 'are_you_sure_you_want_to_pay_to_upgrade_to_pro_', 'Are you sure you want to upgrade to PRO?', 'هل أنت متأكد أنك تريد الترقية إلى الموالية؟', 'Weet je zeker dat je wilt upgraden naar Pro?', 'Êtes-vous sûr de vouloir passer à Pro?', 'Möchten Sie sicher, dass Sie das Upgrade auf Pro aktualisieren möchten?', 'Вы уверены, что хотите обновить до Pro?', '¿Estás seguro de que quieres actualizar a Pro?', 'Pro\'ya yükseltmek istediğinize emin misiniz?'),
(954, '', '', 'you_don_t_have_enough_money_please_top_up_your_wallet', 'You dont have enough money please top up your wallet', 'ليس لديك ما يكفي من المال يرجى توبيخ محفظتك', 'Je hebt niet genoeg geld, vul je portemonnee bij', 'Vous n\'avez pas assez d\'argent s\'il vous plaît recharger votre portefeuille', 'Sie haben nicht genug Geld, bitte tippen Sie Ihre Brieftasche auf', 'У вас не хватает денег, пожалуйста, пополните свой кошелек', 'No tienes suficiente dinero por favor recarga tu billetera', 'Yeterince para yok, lütfen cüzdanını doldur'),
(955, '', '', 'interested', 'Interested', 'مهتم', 'Geïnteresseerd', 'Intéressé', 'Interessiert', 'Заинтересовать', 'Interesado', 'Ilgilenen'),
(956, '', '', 'no_more_views', 'No More Views', 'لا مزيد من المشاهدات', 'Geen weergaven', 'Pas plus de vues', 'Keine Ansichten mehr.', 'Нет больше просмотров', 'No más vistas', 'Daha fazla görünüm yok'),
(957, '', '', 'are_you_sure_you_want_to_delete_your_story_', 'Are you sure you want to delete your story?', 'هل أنت متأكد أنك تريد حذف قصتك؟', 'Weet je zeker dat je je verhaal wilt verwijderen?', 'Êtes-vous sûr de vouloir supprimer votre histoire?', 'Möchten Sie Ihre Geschichte sicher, dass Sie Ihre Geschichte löschen möchten?', 'Вы уверены, что хотите удалить свою историю?', '¿Estás seguro de que quieres eliminar tu historia?', 'Hikayeni silmek istediğinize emin misiniz?'),
(958, '', '', 'please_add_a_new_address', 'Please add a new address', 'يرجى إضافة عنوان جديد', 'Voeg alstublieft een nieuw adres toe', 'S\'il vous plaît ajouter une nouvelle adresse', 'Bitte fügen Sie eine neue Adresse hinzu', 'Пожалуйста, добавьте новый адрес', 'Por favor agregue una nueva dirección', 'Lütfen yeni bir adres ekle'),
(959, '', '', 'please_select_address', 'Please select address', 'يرجى اختيار العنوان', 'Selecteer adres', 'Veuillez sélectionner l\'adresse', 'Bitte wählen Sie Adresse', 'Пожалуйста, выберите адрес', 'Por favor seleccione la dirección', 'Lütfen adresi seçin'),
(960, '', '', 'refund', 'Refund', 'استرداد', 'Terugbetaling', 'Remboursement', 'Erstattung', 'Возвращать деньги', 'Reembolso', 'Geri ödeme'),
(961, '', '', 'create_event', 'Create Event', 'انشاء حدث', 'Creëer evenement', 'Créer un évènement', 'Event erstellen.', 'Создать событие', 'Crear evento', 'Etkinlik oluşturmak'),
(962, '', '', 'checkout', 'Checkout', 'الدفع', 'Uitchecken', 'Vérifier', 'Auschecken', 'Проверить', 'Verificar', 'Ödeme'),
(963, '', '', 'store_orders', 'Store Orders', 'أوامر المتجر', 'Bestellingen opslaan', 'Commandes', 'Aufträge aufbewahren', 'Заказы на хранилище', 'Órdenes de la tienda', 'Mağaza siparişleri'),
(964, '', '', 'my_orders', 'My Orders', 'طلباتي', 'mijn bestellingen', 'Mes commandes', 'meine Bestellungen', 'мои заказы', 'Mis ordenes', 'Siparişlerim'),
(965, '', '', 'no_request_found', 'No request found', 'لم يتم العثور على طلب', 'Geen aanvraag gevonden', 'Aucune demande trouvée', 'Keine Anfrage gefunden', 'Ни один запрос не обнаружен', 'No se encontró ninguna solicitud', 'İstek bulunamadı');
INSERT INTO `langs` (`id`, `ref`, `options`, `lang_key`, `english`, `arabic`, `dutch`, `french`, `german`, `russian`, `spanish`, `turkish`) VALUES
(966, '', '', 'delete_event', 'Delete Event', 'حذف الحدث', 'Evenement verwijderen', 'Supprimer l\'événement', 'Event löschen.', 'Удалить событие', 'Eliminar evento', 'Etkinliği sil'),
(967, '', '', 'cashfree', 'Cashfree', 'cashfree.', 'Cashfree', 'Sans argent', 'Barrierefrei', 'Кашельство', 'CashFree', 'Cashfree'),
(968, '', '', 'paystack', 'Paystack', 'Paystack.', 'Paystack', 'Paysack', 'PayStack', 'Платный плата', 'Paystack', 'Paystack'),
(969, '', '', 'razorpay', 'Razorpay', 'Razorpay.', 'Razorpay', 'Razorpay', 'Razorpay.', 'Razorpay.', 'Razorpay', 'Razörpay'),
(970, '', '', 'paysera', 'Paysera', 'Paysera.', 'Salarisa', 'Paysera', 'Paysera.', 'Paysera', 'Paysera', 'Paysera'),
(971, '', '', 'iyzipay', 'Iyzipay', 'iyzipay.', 'Iyzipay', 'Iyzipay', 'IYZIPAY.', 'Iyzipay', 'IYZIPAY', 'İyzipay'),
(972, '', '', 'payu', 'Payu', 'بدين', 'Payu', 'Paie', 'Payu.', 'Окупаемость', 'Payu', 'Ötesi'),
(973, '', '', 'securionpay', 'Securionpay', 'securionpay.', 'Securionpay', 'SecurionPay', 'SecurionPay.', 'Securionpay.', 'PAYO DE SECURION', 'Securionpay'),
(974, '', '', 'authorize', 'Authorize', 'أذن', 'Toestemming geven', 'Autoriser', 'Autorisieren', 'Разрешать', 'Autorizar', 'Yetki vermek'),
(975, '', '', 'placed', 'Placed', 'وضع', 'Geplaatst', 'Mis', 'Platziert', 'Размещены', 'Metido', 'Yerleştirilmiş'),
(976, '', '', 'canceled', 'Canceled', 'ألغيت', 'Geannuleerd', 'Annulé', 'Abgesagt', 'Отменил', 'Cancelado', 'İptal edildi'),
(977, '', '', 'packed', 'Packed', 'معباه', 'Ingepakt', 'Emballé', 'Verpackt', 'Упакованный', 'Lleno', 'Paketlenmiş'),
(978, '', '', 'commission', 'Commission', 'لجنة', 'Commissie', 'Commission', 'Kommission', 'Комиссия', 'Comisión', 'komisyon'),
(979, '', '', 'final_price', 'Final Price', 'السعر النهائي', 'Uiteindelijke prijs', 'Prix ​​final', 'Endgültiger Preis', 'Окончательная цена', 'Precio final', 'Son fiyat'),
(980, '', '', 'link', 'Link', 'وصلة', 'Koppeling', 'Relier', 'Verknüpfung', 'Ссылка', 'Enlace', 'Bağlantı'),
(981, '', '', 'site_commission', 'Site Commission', 'مفوضية الموقع', 'Sitecommissie', 'Commission de site', 'Standortkommission', 'Комиссия сайта', 'Comisión del sitio', 'Site Komisyonu'),
(982, '', '', 'currently_unavailable.', 'Currently unavailable.', 'غير متاح حاليا.', 'Momenteel niet beschikbaar.', 'Actuellement indisponible.', 'Momentan nicht verfügbar.', 'В настоящее время недоступен.', 'Actualmente no disponible.', 'Şu anda kullanılamıyor.'),
(983, '', '', 'write_review', 'Write Review', 'أكتب مراجعة', 'Schrijf recensie', 'Ecrire une critique', 'Bewertung schreiben', 'Написать обзор', 'Escribir un comentario', 'Yorum yaz'),
(984, '', '', 'photos', 'Photos', 'الصور', 'Foto\'s', 'Photos', 'Fotos', 'Фото', 'Fotografías', 'Fotoğraflar'),
(985, '', '', 'verified_purchase', 'Verified Purchase', 'التحقق من الشراء', 'Geverifieerde aankoop', 'Achat vérifié', 'Geprüfter Kauf.', 'Проверенная покупка', 'Compra verificada', 'Doğrulanmış Satınalma'),
(986, '', '', 'events', 'Events', 'الأحداث', 'Gebeurtenissen', 'Événements', 'Veranstaltungen', 'События', 'Eventos', 'Olaylar'),
(987, '', '', 'my_addresses', 'My Addresses', 'عناويني', 'Mijn adressen', 'Mes adresses', 'Meine Adressen', 'Мои адреса', 'Mis direcciones', 'Adresim'),
(988, '', '', 'add_new', 'Add New', 'اضف جديد', 'Voeg nieuw toe', 'Ajouter de nouveau', 'Neue hinzufügen', 'Добавить новое', 'Añadir nuevo', 'Yeni ekle'),
(989, '', '', 'edit_address', 'Edit Address', 'تعديل العنوان', 'verander adres', 'Modifier l\'adresse', 'Adresse bearbeiten', 'Редактировать адрес', 'Editar dirección', 'Adresi düzelt'),
(990, '', '', 'postcode___zip', 'Postcode / Zip', 'الرمز البريدي / الرمز البريدي', 'Postcode / ZIP', 'Code postal / zip', 'Postleitzahl / Zip.', 'Почтовый индекс / Почтовый индекс', 'Código postal / ZIP', 'Posta kodu / zip'),
(991, '', '', 'invitation_links', 'Invitation Links', 'روابط الدعوة', 'Uitnodigingsverbindingen', 'Liens d\'invitation', 'Einladungslinks', 'Пригласительные ссылки', 'Enlaces de invitación', 'Davetiye bağlantıları'),
(992, '', '', 'available_links', 'Available Links', 'الروابط المتاحة', 'Beschikbare links', 'Liens disponibles', 'Verfügbare Links', 'Доступные ссылки', 'Enlaces disponibles', 'Mevcut bağlantılar'),
(993, '', '', 'generated_links', 'Generated Links', 'روابط ولدت', 'Gegenereerde links', 'Liens générés', 'Erzeugte Links', 'Сгенерированные ссылки', 'Enlaces generados', 'Oluşturulan bağlantılar'),
(994, '', '', 'used_links', 'Used Links', 'روابط مستعملة', 'Gebruikte links', 'Liens d\'occasion', 'Gebrauchte Links', 'Используемые ссылки', 'Enlaces usados', 'Kullanılan linkler'),
(995, '', '', 'generate_link', 'Generate Link', 'توليد رابط', 'Link genereren', 'Générer un lien', 'Verbindung generieren', 'Генерировать ссылку', 'Generar enlace', 'Bağlantı Oluştur'),
(996, '', '', 'invited_user', 'Invited User', 'دعوة المستخدم', 'Uitgenodigde gebruiker', 'Utilisateur invité', 'Eingeladener Benutzer', 'Приглашенный пользователь', 'Usuario invitado', 'Davetli kullanıcı'),
(997, '', '', 'date', 'Date', 'تاريخ', 'Datum', 'Date', 'Datum', 'Дата', 'Fecha', 'Tarih'),
(998, '', '', 'copy', 'Copy', 'ينسخ', 'Kopiëren', 'Copie', 'Kopieren', 'Скопировать', 'Dupdo', 'Kopya'),
(999, '', '', 'copied', 'Copied', 'نسخ', 'Gekopieerd', 'Copié', 'Kopiert', 'Скопирован', 'Copiado', 'Kopyalandı'),
(1000, '', '', 'available_wallet', 'Available wallet', 'المحفظة المتاحة', 'Beschikbare portemonnee', 'Portefeuille disponible', 'Verfügbare Geldbörse', 'Доступный кошелек', 'Billetera disponible', 'Mevcut cüzdan'),
(1001, '', '', 'top_up_wallet', 'Top up wallet', 'أعلى المحفظة', 'Top-up portemonnee', 'Top up portefeuille', 'Wallet auffüllen', 'Пополнить кошелек', 'Tapa de la cartera', 'Topla cüzdan'),
(1002, '', '', 'hall_of_fame', 'Hall of fame', 'قاعة الشهرة', 'Hall of fame', 'Temple de la renommée', 'Ruhmeshalle', 'Зал славы', 'Salón de la Fama', 'Onur listesi'),
(1003, '', '', 'analytics', 'Analytics', 'تحليلات', 'Analytiek', 'Analytique', 'Analytik', 'Аналитика', 'Analítica', 'Analitik'),
(1004, '', '', 'more_info', 'More Info', 'مزيد من المعلومات', 'Meer informatie', 'Plus d\'informations', 'Mehr Info', 'Больше информации', 'Más información', 'Daha fazla bilgi'),
(1005, '', '', 'listen_in_youtube', 'Listen in Youtube', 'اسمع في يوتيوب', 'Luister in YouTube', 'Écouter en youtube', 'Hören Sie auf YouTube an', 'Слушай в YouTube', 'Escucha en YouTube', 'YouTube\'da dinleyin'),
(1006, '', '', 'tagged_artists', 'Tagged Artists', 'الفنانين الموسومة', 'Tagged artiesten', 'Artistes marqués', 'Tagged Künstler', 'Тегистых художников', 'Artistas etiquetados', 'Tagged sanatçılar'),
(1007, '', '', 'donate', 'Donate', 'يتبرع', 'Doneren', 'Faire un don', 'Spenden', 'Пожертвовать', 'Donar', 'Bağış yapmak'),
(1008, '', '', 's_other', 'Other', 'آخر', 'Ander', 'Autre', 'Sonstiges', 'Другой', 'Otro', 'Başka'),
(1009, '', '', 's_clothes', 'Clothes', 'ملابس', 'Kleren', 'Vêtements', 'Kleider', 'Одежда', 'Ropa', 'Çamaşırlar'),
(1010, '', '', 's_electronic', 'Electronic', 'الإلكترونية', 'Elektronisch', 'Électronique', 'Elektronisch', 'Электронный', 'Electrónico', 'Elektronik'),
(1011, '', '', 'remove_from_cart', 'Remove From Cart', 'إزالة من العربة', 'Verwijderen van winkelwagen', 'Supprimer du panier', 'Aus dem Warenkorb entfernen', 'Удалить из корзины', 'Quitar del carrito', 'Arabadan çıkar'),
(1012, '', '', 'add_to_cart', 'Add To Cart', 'أضف إلى السلة', 'Voeg toe aan winkelkar', 'Ajouter au panier', 'In den Warenkorb legen', 'Добавить в корзину', 'Añadir al carrito', 'Sepete ekle'),
(1013, '', '', 'your_cart_is_empty.', 'Your cart is empty.', 'عربة التسوق فارغة.', 'Uw winkelwagen is leeg.', 'Votre panier est vide.', 'Ihr Warenkorb ist leer.', 'Ваша корзина пуста.', 'Tu carrito esta vacío.', 'Sepetiniz boş.'),
(1014, '', '', 'delete_your_address', 'Delete your address', 'حذف عنوانك', 'Verwijder uw adres', 'Supprimer votre adresse', 'Löschen Sie Ihre Adresse', 'Удалить свой адрес', 'Elimina tu dirección', 'Adresinizi Sil'),
(1015, '', '', 'are_you_sure_you_want_to_delete_this_address_', 'Are you sure you want to delete this address?', 'هل أنت متأكد من أنك تريد حذف هذا العنوان؟', 'Weet je zeker dat je dit adres wilt verwijderen?', 'Êtes-vous sûr de vouloir supprimer cette adresse?', 'Möchten Sie diese Adresse sicher, dass Sie diese Adresse löschen möchten?', 'Вы уверены, что хотите удалить этот адрес?', '¿Está seguro de que desea eliminar esta dirección?', 'Bu adresi silmek istediğinize emin misiniz?'),
(1016, '', '', 'payment_alert', 'Payment Alert', 'تنبيه الدفع', 'Betalingswaarschuwing', 'Alerte de paiement', 'Zahlungsalarm', 'Оплата', 'Alerta de pago', 'Ödeme uyarısı'),
(1017, '', '', 'are_you_sure_you_want_to_pay_', 'Are you sure you want to pay?', 'هل أنت متأكد أنك تريد أن تدفع؟', 'Weet je zeker dat je wilt betalen?', 'Êtes-vous sûr de vouloir payer?', 'Bist du sicher, dass du zahlen willst?', 'Вы уверены, что хотите заплатить?', '¿Estás seguro de que quieres pagar?', 'Ödemek istediğinize emin misiniz?'),
(1018, '', '', 'delete_your_product', 'Delete your product', 'حذف المنتج الخاص بك', 'Verwijder uw product', 'Supprimer votre produit', 'Löschen Sie Ihr Produkt', 'Удалить ваш продукт', 'Elimina tu producto', 'Ürününüzü silin'),
(1019, '', '', 'are_you_sure_you_want_to_delete_this_product_', 'Are you sure you want to delete this product?', 'هل أنت متأكد أنك تريد حذف هذا المنتج؟', 'Weet je zeker dat je dit product wilt verwijderen?', 'Êtes-vous sûr de vouloir supprimer ce produit?', 'Möchten Sie dieses Produkt sicher, dass Sie dieses Produkt löschen möchten?', 'Вы уверены, что хотите удалить этот продукт?', '¿Está seguro de que desea eliminar este producto?', 'Bu ürünü silmek istediğinize emin misiniz?'),
(1020, '', '', 'pay_for_story', 'Pay for story', 'دفع ثمن القصة', 'Betaal voor het verhaal', 'Payer pour l\'histoire', 'Für die Geschichte bezahlen', 'Платить за историю', 'Pagar por la historia', 'Hikaye için ödeme yapmak'),
(1021, '', '', 'are_you_sure_you_want_to_pay_for_create_story_', 'Are you sure you want to pay for create story?', 'هل أنت متأكد أنك تريد أن تدفع مقابل قصة خلق؟', 'Weet je zeker dat je wilt betalen voor het maken van verhaal?', 'Êtes-vous sûr de vouloir payer pour créer une histoire?', 'Möchten Sie sicher, dass Sie für die Schaffung von Geschichte bezahlen möchten?', 'Вы уверены, что хотите заплатить за создать историю?', '¿Estás seguro de que quieres pagar por crear historia?', 'Hikaye oluşturmak için ödemek istediğinize emin misiniz?'),
(1022, '', '', 'pay_from_wallet', 'Pay from wallet', 'دفع من المحفظة', 'Betaal van portemonnee', 'Payer du portefeuille', 'Bezahlen Sie von der Brieftasche', 'Платить из кошелька', 'Pagar de billetera', 'Cüzdandan ödeme'),
(1023, '', '', 'are_you_sure_you_want_to_buy_a_ticket_', 'Are you sure you want to buy a ticket?', 'هل أنت متأكد أنك تريد شراء تذكرة؟', 'Weet je zeker dat je een ticket wilt kopen?', 'Êtes-vous sûr de vouloir acheter un billet?', 'Möchten Sie sicher, dass Sie ein Ticket kaufen möchten?', 'Вы уверены, что хотите купить билет?', '¿Estás seguro de que quieres comprar un boleto?', 'Bir bilet satın almak istediğinize emin misiniz?'),
(1024, '', '', 'leave_event', 'Leave event', 'حدث المغادرة', 'Gebeurtenis', 'Quitter l\'événement', 'Veranstaltung verlassen', 'Оставьте событие', 'Dejar evento', 'Olay bırakmak'),
(1025, '', '', 'are_you_sure_you_want_to_leave_this_event_', 'Are you sure you want to leave this event?', 'هل أنت متأكد أنك تريد أن تترك هذا الحدث؟', 'Weet je zeker dat je dit evenement wilt verlaten?', 'Êtes-vous sûr de vouloir quitter cet événement?', 'Sind Sie sicher, dass Sie dieses Ereignis verlassen möchten?', 'Вы уверены, что хотите покинуть это событие?', '¿Estás seguro de que quieres dejar este evento?', 'etkinlikten ayrılmak istediğinize emin misiniz?'),
(1026, '', '', 'leave', 'Leave', 'يترك', 'Vertrekken', 'Laisser', 'Verlassen', 'Оставлять', 'Dejar', 'Terk etmek'),
(1027, '', '', 'delete_your_event', 'Delete your event', 'حذف الحدث الخاص بك', 'Verwijder uw evenement', 'Supprimer votre événement', 'Löschen Sie Ihre Veranstaltung', 'Удалить свое мероприятие', 'Elimina tu evento', 'Etkinliğinizi Sil'),
(1028, '', '', 'are_you_sure_you_want_to_delete_this_event_', 'Are you sure you want to delete this event?', 'هل أنت متأكد من حذف هذا الحدث؟', 'Weet je zeker dat je dit evenement wilt verwijderen?', 'Êtes-vous sûr de vouloir supprimer cet événement?', 'Sind Sie sicher, dass Sie dieses Ereignis löschen möchten?', 'Вы уверены, что хотите удалить это событие?', '¿Estás seguro de que quieres eliminar este evento?', 'Bu etkinliği silmek istediğinizden emin misiniz?'),
(1029, '', '', 'get_verified___sell_your_songs___sell_products___create_events_and_sell_tickets___get_a_special_looking_profile_and_get_famous_on_our_platform_', 'Get verified, sell your songs, Sell products, Create events and sell tickets, get a special looking profile and get famous on our platform!', 'الحصول على التحقق، وبيع أغانيك، وبيع المنتجات، وخلق أحداث وبيع تذاكر، والحصول على ملف تعريف خاص ويشتهر في منصاتنا!', 'Get Verified, verkoop uw nummers, verkoop producten, maak evenementen en verkoop tickets, ontvang een speciaal uitziende profiel en wordt beroemd op ons platform!', 'Obtenez vérifié, vendez vos chansons, vendez des produits, créez des événements et vendez des billets, obtenez un profil spécial et renommez sur notre plate-forme!', 'Get nachgewiesen, verkaufen Sie Ihre Songs, verkaufen Sie Produkte, erstellen Sie Events und verkaufen Sie Tickets, erhalten Sie ein spezielles Profil und berühmt auf unserer Plattform!', 'Проверено, продавайте свои песни, продавайте продукты, создайте мероприятия и продажи билетов, получите специальный профиль и получите знаменитую на нашей платформе!', '¡Verifiede, vende sus canciones, venda productos, cree eventos y venda boletos, obtenga un perfil de aspecto especial y hágase famoso en nuestra plataforma!', 'Doğrulanmış, şarkılarınızı satmak, ürünleri satmak, etkinlikler oluşturmak ve bilet satmak, özel bir profil almak ve platformumuzla ünlü almak!'),
(1030, '', '', 'get_verified___sell_your_songs___create_events_and_sell_tickets___get_a_special_looking_profile_and_get_famous_on_our_platform_', 'Get verified, sell your songs, Create events and sell tickets, get a special looking profile and get famous on our platform!', 'الحصول على التحقق، وبيع أغانيك، وخلق الأحداث وبيع التذاكر، والحصول على ملف تعريف خاص ويشتهر في منصة لدينا!', 'Get Verified, verkoop je nummers, maak evenementen en verkoop tickets, krijg een speciaal uitziende profiel en word beroemd op ons platform!', 'Obtenez vérifié, vendez vos chansons, créez des événements et vendez des billets, obtenez un profil spécial et vous familiariser sur notre plate-forme!', 'Überprüfen Sie, verifizieren Sie Ihre Songs, erstellen Sie Events und verkaufen Sie Tickets, erhalten Sie ein spezielles Profil und berühmt auf unserer Plattform!', 'Получите проверенные, продавайте свои песни, создайте события и продажи билетов, получите специальный профиль и получите знаменитую на нашей платформе!', '¡Consigue su verificación, vende sus canciones, cree eventos y venda boletos, obtenga un perfil de aspecto especial y hágase famoso en nuestra plataforma!', 'Doğrulanmış, şarkılarınızı satın, etkinlikler oluşturun ve bilet satmak, özel görünümlü bir profil alın ve platformumuzda ünlü olun!'),
(1031, '', '', 'get_verified___sell_your_songs___sell_products___get_a_special_looking_profile_and_get_famous_on_our_platform_', 'Get verified, sell your songs, sell products, get a special looking profile and get famous on our platform!', 'الحصول على التحقق، وبيع أغانيك، وبيع المنتجات، والحصول على ملف تعريف خاص ويشتهر في منصتنا!', 'Ontvang geverifieerd, verkoop je songs, verkoop producten, krijg een speciaal uitziende profiel en word beroemd op ons platform!', 'Vérifiez, vendez vos chansons, vendez des produits, obtenez un profil spécial et vous familiarisez sur notre plate-forme!', 'Überprüfen Sie, verkaufen Sie Ihre Songs, verkaufen Sie Produkte, erhalten Sie ein spezielles Profil und berühmt auf unserer Plattform!', 'Получите проверку, продайте свои песни, продайте продукты, получите специальный поиск профиль и получите знаменитую на нашей платформе!', '¡Verifiede, venda sus canciones, venda productos, obtenga un perfil de aspecto especial y se vuelva famosa en nuestra plataforma!', 'Doğrulanmış, şarkılarınızı satmak, ürünleri satmak, özel görünümlü bir profil alın ve platformumuzda ünlü olun!'),
(1032, '', '', 'get_verified___sell_your_songs___get_a_special_looking_profile_and_get_famous_on_our_platform_', 'Get verified, sell your songs, get a special looking profile and get famous on our platform!', 'الحصول على التحقق، وبيع أغانيك، والحصول على ملف تعريف خاص ويشتهر في منصتنا!', 'Get Verified, verkoop je nummers, krijg een speciaal uitziende profiel en word beroemd op ons platform!', 'Obtenez vérifié, vendez vos chansons, obtenez un profil spécial et vous familiariser sur notre plate-forme!', 'Verifizieren, verkaufen Sie Ihre Songs, holen Sie sich ein spezielles Profil aus und berühmt auf unserer Plattform!', 'Получите проверку, продайте свои песни, получите специальный поиск профиль и получите знаменитую нашу платформу!', '¡Verifiede, vende sus canciones, obtenga un perfil de aspecto especial y hágase famoso en nuestra plataforma!', 'Doğrulanmış, şarkılarınızı satar, özel bir görünüm kazanın ve platformumuzda ünlü olun!'),
(1033, '', '', 'no_events_found', 'No events found', 'لا توجد أحداث وجدت', 'Geen evenementen gevonden', 'Aucun événement trouvé', 'Keine Ereignisse gefunden', 'События не найдены', 'No se han encontrado eventos', 'Etkinlik bulunamadı'),
(1034, '', '', 'event', 'Event', 'حدث', 'Evenement', 'Événement', 'Vorfall', 'Мероприятие', 'Evento', 'Etkinlik'),
(1035, '', '', 'product', 'Product', 'المنتج', 'Product', 'Produit', 'Produkt', 'Продукт', 'Producto', 'Ürün'),
(1036, '', '', 'donate_button', 'Donate Button', 'تبرع زر', 'Doneer knop', 'Bouton DONE', 'Knopf spenden', 'Пожертвовать кнопку', 'Botón de donar', 'Bağış düğmesi'),
(1037, '', '', 'my_information', 'My Information', 'معلوماتي', 'Mijn informatie', 'Mon information', 'Meine Information', 'Моя информация', 'Mi informacion', 'Benim bilgim'),
(1038, '', '', 'please_choose_which_information_you_would_like_to_download', 'Please choose which information you would like to download.', 'يرجى اختيار المعلومات التي ترغب في تنزيلها.', 'Kies welke informatie u wilt downloaden.', 'Veuillez choisir les informations que vous souhaitez télécharger.', 'Bitte wählen Sie, welche Informationen Sie herunterladen möchten.', 'Пожалуйста, выберите, какую информацию вы хотите скачать.', 'Por favor, elija qué información desea descargar.', 'Lütfen hangi bilgileri indirmek istediğinizi seçin.'),
(1039, '', '', 'generate_file', 'Generate file', 'توليد الملف', 'Het bestand genereren', 'Générer un fichier', 'Datei generieren', 'Генерировать файл', 'Generar archivo', 'Dosya Oluştur'),
(1040, '', '', 'your_event_has_been_published_successfully', 'Your event has been published successfully', 'تم نشر الحدث الخاص بك بنجاح', 'Uw evenement is succesvol gepubliceerd', 'Votre événement a été publié avec succès', 'Ihre Veranstaltung wurde erfolgreich veröffentlicht', 'Ваше мероприятие было успешно опубликовано', 'Su evento ha sido publicado con éxito.', 'Etkinliğiniz başarıyla yayınlandı'),
(1041, '', '', 'no_tickets_found', 'No tickets found', 'لم يتم العثور على تذاكر', 'Geen tickets gevonden', 'Aucun billet trouvé', 'Keine Tickets gefunden', 'Билеты не найдено', 'No se han encontrado boletos', 'Bilet bulunamadı'),
(1042, '', '', 'purchased_tickets', 'Purchased Tickets', 'اشترى التذاكر', 'Gekochte tickets', 'Billets achetés', 'Gekaufte Tickets', 'Купленные билеты', 'Entradas compradas', 'Satın alınan biletler'),
(1043, '', '', 'your_event_has_been_updated_successfully', 'Your event has been updated successfully', 'تم تحديث حدثك بنجاح', 'Uw evenement is succesvol bijgewerkt', 'Votre événement a été mis à jour avec succès', 'Ihre Veranstaltung wurde erfolgreich aktualisiert', 'Ваше мероприятие успешно обновлено', 'Su evento ha sido actualizado con éxito.', 'Etkinliğiniz başarıyla güncellendi'),
(1044, '', '', 'your_product_is_under_review', 'Your product is under review', 'المنتج الخاص بك قيد المراجعة', 'Uw product wordt beoordeeld', 'Votre produit est à l\'étude', 'Ihr Produkt ist überprüft', 'Ваш продукт находится под рассмотрением', 'Tu producto esta bajo revisión', 'Ürününüz incelenmiştir'),
(1045, '', '', 'your_product_has_been_published_successfully', 'Your product has been published successfully', 'تم نشر منتجك بنجاح', 'Uw product is succesvol gepubliceerd', 'Votre produit a été publié avec succès', 'Ihr Produkt wurde erfolgreich veröffentlicht', 'Ваш продукт успешно опубликован', 'Su producto ha sido publicado con éxito.', 'Ürününüz başarıyla yayınlandı'),
(1046, '', '', 'edit_product', 'Edit Product', 'تحرير المنتج', 'Bewerk product', 'Modifier le produit', 'Produkt bearbeiten', 'Редактировать продукт', 'Editar producto', 'Ürün Düzenle'),
(1047, '', '', 'your_product_has_been_edited_successfully', 'Your product has been edited successfully', 'تم تحرير منتجك بنجاح', 'Uw product is succesvol bewerkt', 'Votre produit a été édité avec succès', 'Ihr Produkt wurde erfolgreich bearbeitet', 'Ваш продукт успешно отредактирован', 'Su producto ha sido editado con éxito.', 'Ürününüz başarıyla düzenlendi'),
(1048, '', '', 'guest', 'Guest', 'ضيف', 'Gast', 'Invité', 'Gast', 'Гость', 'Huésped', 'Konuk'),
(1049, '', '', 'ticket', 'Ticket', 'تذكرة', 'Ticket', 'Billet', 'Fahrkarte', 'Проездной билет', 'Billete', 'Bilet'),
(1050, '', '', 'events_analytics', 'Events Analytics', 'أحداث التحليلات', 'Evenementen Analytics', 'Analyse des événements', 'Events Analytics.', 'События аналитики', 'Análisis de eventos', 'Olaylar Analytics'),
(1051, '', '', 'id', 'ID', 'هوية شخصية', 'ID kaart', 'identifiant', 'ICH WÜRDE', 'Я БЫ', 'IDENTIFICACIÓN', 'İD'),
(1052, '', '', 'tag_artists', 'Tag Artists', 'فنانين العلامة', 'Tag artiesten', 'Tag artistes', 'Tag Künstler', 'Теги художников', 'Artistas de etiqueta', 'Sanatçılar Tag'),
(1053, '', '', 'tag_other_artists_to_show_they_performed_together', 'Tag other artists to show they performed together', 'علامة الفنانين الآخرين لإظهار أنها تؤدي معا', 'Tag andere artiesten om te laten zien dat ze samen hebben uitgevoerd', 'Tag d\'autres artistes à montrer qu\'ils ont joué ensemble', 'Andere Künstler, die zeigen, dass sie zusammengearbeitet haben', 'Течь других артистов, чтобы показать, что они выступали вместе', 'Etiquete otros artistas para mostrar que se desempeñaron juntos.', 'Birlikte yaptıklarını göstermek için diğer sanatçıları etiketleyin'),
(1054, '', '', 'download_ticket', 'Download Ticket', 'تحميل تذكرة', 'Ticket downloaden', 'Billet de téléchargement', 'Ticket herunterladen', 'Скачать билет', 'Descargar el boleto', 'Bilet İndir'),
(1055, '', '', 'your_order_has_been_placed_successfully', 'Your order has been placed successfully', 'تم وضع طلبك بنجاح', 'Uw bestelling is succesvol geplaatst', 'Votre commande a été placée avec succès', 'Ihre Bestellung wurde erfolgreich platziert', 'Ваш заказ был успешно размещен', 'Su pedido ha sido realizado con éxito.', 'Siparişiniz başarıyla verildi'),
(1056, '', '', 'order', 'Order', 'ترتيب', 'Volgorde', 'Commander', 'Befehl', 'порядок', 'Pedido', 'Emir'),
(1057, '', '', 'sale_invoice', 'Sale invoice', 'الفاتورة بيع', 'Verkoopfactuur', 'Facture de vente', 'Verkauf Rechnung.', 'Продажа счет', 'Factura de venta', 'Satış faturası'),
(1058, '', '', 'seller_name', 'Seller Name', 'البائع اسم', 'Naam van de verkoper', 'Nom du Vendeur', 'Name des Verkäufers', 'Название продавца', 'Nombre del vendedor', 'Satıcı Adı'),
(1059, '', '', 'seller_email', 'Seller Email', 'البريد الإلكتروني للبائع', 'Verkoper e-mail', 'Vendeur e-mail', 'Verkäufer-E-Mail.', 'По электронной почте продавца', 'Email del vendedor', 'Satıcı e-postası'),
(1060, '', '', 'invoice_to', 'Invoice To', 'فاتورة إلى', 'Factuur aan', 'Facture à', 'Rechnung an', 'Счет-фактуру', 'Factura a', 'Fatura'),
(1061, '', '', 'payment_details', 'Payment Details', 'بيانات الدفع', 'Betalingsdetails', 'Détails de paiement', 'Zahlungsdetails', 'Детали оплаты', 'Detalles del pago', 'Ödeme detayları'),
(1062, '', '', 'total_due', 'Total Due', 'الاجمالي المستحق', 'Totaal verschuldigd', 'Total dû', 'Insgesamt fällig.', 'Всего должное', 'Total de vencimiento', 'Tam olarak'),
(1063, '', '', 'bank_name', 'Bank name', 'اسم البنك', 'banknaam', 'Nom de banque', 'Bank Name', 'название банка', 'Nombre del banco', 'banka adı'),
(1064, '', '', 'item', 'Item', 'غرض', 'Item', 'Article', 'Artikel', 'Элемент', 'Artículo', 'Kalem'),
(1065, '', '', 'download_invoice', 'Download Invoice', 'تحميل فاتورة', 'Factuur downloaden', 'Télécharger la facture', 'Download Rechnung', 'Скачать счет', 'Descargar factura', 'Faturayı indirin'),
(1066, '', '', 'details', 'Details', 'تفاصيل', 'Details', 'Des détails', 'Einzelheiten', 'Подробности', 'Detalles', 'Detaylar'),
(1067, '', '', 'no_products_found', 'No products found', 'لم يتم العثور على المنتجات', 'Geen producten gevonden', 'Aucun produit trouvé', 'Keine Produkte gefunden.', 'Никаких продуктов не найдена', 'No se han encontrado productos', 'Ürün bulunamadı'),
(1068, '', '', 'no_reviews_found', 'No reviews found', 'لم يتم العثور على مراجعات', 'Geen reviews gevonden', 'Aucun commentaire trouvé', 'Keine Bewertungen gefunden', 'Отзывов не найдено', 'No se encontraron opiniones', 'Yorum bulunamadı'),
(1069, '', '', 'you_are_about_to_purchase_the_items__do_you_want_to_proceed_', 'You are about to purchase the items, do you want to proceed?', 'أنت على وشك شراء العناصر، هل تريد المتابعة؟', 'Je staat op het punt om de items te kopen, wil je doorgaan?', 'Vous êtes sur le point d\'acheter les articles, voulez-vous continuer?', 'Sie können die Artikel kaufen, möchten Sie fortfahren?', 'Вы собираетесь приобрести предметы, вы хотите продолжить?', 'Está a punto de comprar los artículos, ¿desea continuar?', 'Öğeleri satın almak üzeresiniz, devam etmek ister misiniz?'),
(1070, '', '', 'request_a_refund', 'Request a Refund', 'طلب استرداد', 'Vraag een terugbetaling', 'Demande à être remboursé', 'Eine Rückerstattung anfordern', 'Запросить возврат', 'Solicitar un reembolso', 'Geri ödeme istemek'),
(1071, '', '', 'new_orders_has_been_placed', 'New orders has been placed.', 'تم وضع أوامر جديدة.', 'Er zijn nieuwe bestellingen geplaatst.', 'Les nouvelles commandes ont été placées.', 'Neuaufträge wurden platziert.', 'Новые заказы были размещены.', 'Se han colocado nuevos pedidos.', 'Yeni siparişler verildi.'),
(1072, '', '', 'order_status_has_been_changed', 'Your order status has been updated.', 'تم تحديث حالة طلبك.', 'Uw bestelstatus is bijgewerkt.', 'Votre statut de commande a été mis à jour.', 'Ihr Bestellstatus wurde aktualisiert.', 'Ваш статус заказа был обновлен.', 'Su estado de pedido ha sido actualizado.', 'Sipariş durumunuz güncellendi.'),
(1073, '', '', 'your_refund_request_has_been_declined', 'Your refund request has been declined.', 'تم رفض طلب استرداد الأموال الخاص بك.', 'Uw terugbetalingsverzoek is geweigerd.', 'Votre demande de remboursement a été refusée.', 'Ihre Erstattungsanfrage wurde abgelehnt.', 'Ваш запрос на возврат был отклонен.', 'Su solicitud de reembolso ha sido rechazada.', 'Geri ödeme isteğiniz reddedildi.'),
(1074, '', '', 'your_refund_request_has_been_approved_your_money_added_to_your_wallet', 'Your refund request has been approved, balance re-added to your wallet.', 'تمت الموافقة على طلب استرداد الأموال الخاص بك، الرصيد إعادة إضافته إلى محفظتك.', 'Uw terugbetalingsverzoek is goedgekeurd, saldo opnieuw toegevoegd aan uw portemonnee.', 'Votre demande de remboursement a été approuvée, balance re-ajoutée à votre portefeuille.', 'Ihre Erstattungsanfrage wurde genehmigt, Balance wird Ihrer Brieftasche erneut hinzugefügt.', 'Ваш запрос на возврат был одобрен, баланс повторно добавляется в ваш кошелек.', 'Su solicitud de reembolso ha sido aprobada, el saldo se ha vuelto a agregar a su billetera.', 'Geri ödeme isteğiniz onaylandı, bakiye cüzdanınıza yeniden eklendi.'),
(1075, '', '', 'added_tracking_info', 'updated the order with tracking information.', 'تحديث الطلب مع معلومات التتبع.', 'de bestelling bijgewerkt met trackinginformatie.', 'Mise à jour de la commande avec des informations de suivi.', 'die Bestellung mit Tracking-Informationen aktualisiert.', 'Обновил заказ с информацией отслеживания.', 'Actualizado el pedido con información de seguimiento.', 'İzleme bilgileri ile sipariş güncellendi.'),
(1076, '', '', 'your_product_has_been_approved', 'Your product has been approved.', 'تمت الموافقة على منتجك.', 'Uw product is goedgekeurd.', 'Votre produit a été approuvé.', 'Ihr Produkt wurde genehmigt.', 'Ваш продукт был одобрен.', 'Su producto ha sido aprobado.', 'Ürününüz onaylandı.'),
(1077, '', '', 'joined_your_event', 'joined your event', 'انضم إلى حدثك', 'voegde zich bij je evenement', 'rejoint votre événement', 'schloss sich Ihrer Veranstaltung an', 'присоединился к вашему событию', 'se unió a su evento', 'Etkinliğinize katıldı'),
(1078, '', '', 'bought_a_ticket', 'bought a ticket, you got a new sale!', 'اشترى تذكرة، حصلت على بيع جديد!', 'Kocht een ticket, je hebt een nieuwe verkoop!', 'acheté un billet, vous avez une nouvelle vente!', 'Kaufte ein Ticket, du hast einen neuen Verkauf!', 'Купил билет, у вас есть новая распродажа!', '¡Compró un boleto, tienes una nueva venta!', 'Bir bilet aldım, yeni bir satışın var!'),
(1079, '', '', 'orders', 'Orders', 'الطلب #٪ s', 'Bestellingen', 'Ordres', 'Aufträge', 'Заказывает', 'Pedidos', 'Emirler'),
(1080, '', '', 'you_are_not_purchased', 'You didn\'t purchase this item.', 'أنت لم تشتري هذا البند.', 'U hebt dit artikel niet gekocht.', 'Vous n\'avez pas acheté cet article.', 'Sie haben diesen Artikel nicht gekauft.', 'Вы не купили этот товар.', 'No compró este artículo.', 'Bu öğeyi satın almadınız.'),
(1081, '', '', 'order_not_found', 'Order not found', 'غير موجود', 'Bestellen niet gevonden', 'Commande introuvable', 'Bestellen nicht gefunden', 'Не найден', 'Orden no encontrado', 'Sipariş bulunamadı'),
(1082, '', '', 'if_the_order_status_wasn_t_set_to_delivered_within_60_days_from_the_order_date__it_will_be_automatically_be_sent_to__delivered_.', 'If the order status wasn\'t set to delivered within 60 days from the order date, it will be automatically be set to Delivered.', 'إذا لم يتم تعيين حالة الطلب لتسليمها في غضون 60 يوما من تاريخ الطلب، فسيتم تعيينه تلقائيا لتسليمه.', 'Als de bestelstatus niet is ingesteld op afgeleverd binnen 60 dagen na de besteldatum, wordt deze automatisch ingesteld op afgeleverd.', 'Si l\'état de la commande n\'était pas défini sur livré dans les 60 jours à compter de la date de la commande, il sera automatiquement défini sur livré.', 'Wenn der Bestellstatus nicht innerhalb von 60 Tagen ab dem Bestelldatum angeliefert wurde, wird es automatisch aufgeliefert.', 'Если статус заказа не был установлен для доставки в течение 60 дней с даты заказа, он будет автоматически установлен для доставки.', 'Si el estado del pedido no se configuró para entregar dentro de 60 días a partir de la fecha del pedido, se establecerá automáticamente en entregarse.', 'Sipariş durumu, sipariş tarihinden itibaren 60 gün içinde teslim edilmemişse, otomatik olarak teslim edilecek şekilde ayarlanacaktır.'),
(1083, '', '', 'if_the_order_wasn_t_actually_delivered__the_buyer_can_request_a_refund.', 'If the order wasnt actually delivered, the buyer can request a refund.', 'إذا لم يتم تسليم الطلب بالفعل، يمكن للمشتري طلب استرداد.', 'Als de bestelling niet daadwerkelijk is afgeleverd, kan de koper een terugbetaling aanvragen.', 'Si la commande n\'a pas été réellement livrée, l\'acheteur peut demander un remboursement.', 'Wenn die Bestellung nicht tatsächlich geliefert wurde, kann der Käufer eine Rückerstattung anfordern.', 'Если заказ на самом деле не был доставлен, покупатель может запросить возмещение.', 'Si el pedido no se entregó en realidad, el comprador puede solicitar un reembolso.', 'Sipariş aslında teslim edilmediyse, alıcı bir geri ödeme talebinde bulunabilir.'),
(1084, '', '', 'your_request_is_under_review', 'Your request is under review.', 'طلبك قيد المراجعة.', 'Uw aanvraag wordt beoordeeld.', 'Votre demande est à l\'étude.', 'Ihre Anfrage ist überprüft.', 'Ваш запрос находится под контролем.', 'Su solicitud está bajo revisión.', 'İsteğiniz inceleme altında.'),
(1085, '', '', 'request', 'Request', 'طلب', 'Verzoek', 'Demander', 'Anfrage', 'Запрос', 'Solicitud', 'Rica etmek'),
(1086, '', '', 'please_explain_the_reason', 'Please explain the reason', 'يرجى توضيح السبب', 'Leg de reden uit', 'S\'il vous plaît expliquer la raison', 'Bitte erkläre den Grund', 'Пожалуйста, объясните причину', 'Por favor explique la razón', 'Lütfen nedeni açıklayın'),
(1087, '', '', 'top_products', 'Top Products', 'أعلى المنتجات', 'Topproducten', 'Top produits', 'Top-Produkte', 'Лучшие товары', 'Top Products', 'Üst Ürünler'),
(1088, '', '', 'best_selling_songs___products_this_week', 'Best Selling Songs &amp; Products This Week', 'أفضل الأغاني والمنتجات الأكثر مبيعا هذا الأسبوع', 'Best Selling Songs & Products deze week', 'Les meilleures chansons et produits de vente cette semaine', 'Bestseller Songs & Produkte Diese Woche', 'Лучшие продажи песни и продукты на этой неделе', 'Canciones y productos más vendidos esta semana', 'Bu hafta en çok satan şarkılar ve ürünler'),
(1089, '', '', 'best_selling_songs___albums_this_week', 'Best Selling Songs &amp; Albums This Week', 'أفضل الأغاني والألبومات هذا الأسبوع', 'Best Selling Songs & Albums deze week', '', 'Bestseller Songs & Alben Diese Woche', 'Лучшие продажи песен и альбомы на этой неделе', 'Canciones y álbumes más vendidos esta semana', 'Bu hafta en çok satan şarkılar ve albümler'),
(1090, '', '', 'accepted_', 'Accepted', 'وافقت', 'Geaccepteerd', '', 'Akzeptiert', 'Принято', 'Aceptado', 'Kabul edilmiş'),
(1091, '', '', 'please_wait__this_may_take_few_minutes.', 'Please wait, this may take few minutes.', 'يرجى الانتظار، قد يستغرق هذا بضع دقائق.', 'Even geduld, dit kan enkele minuten duren.', 'Veuillez patienter, cela peut prendre quelques minutes.', 'Bitte warten, dies kann nur wenige Minuten dauern.', 'Пожалуйста, подождите, это может занять несколько минут.', 'Por favor, espere, esto puede tardar unos minutos.', 'Lütfen bekleyin, bu birkaç dakika sürebilir.'),
(1092, '', '', 'instead_of_uploading_a_song__you_can_easily_import_songs_using', 'Instead of uploading a song, you can easily import songs using', 'بدلا من تحميل أغنية، يمكنك بسهولة استيراد الأغاني باستخدام', 'In plaats van een nummer te uploaden, kunt u eenvoudig nummers importeren met', 'Au lieu de télécharger une chanson, vous pouvez facilement importer des chansons en utilisant', 'Anstatt ein Lied hochzuladen, können Sie Songs problemlos importieren', 'Вместо того, чтобы загрузить песню, вы можете легко импортировать песни, используя', 'En lugar de cargar una canción, puede importar fácilmente las canciones usando', 'Bir şarkı yüklemek yerine, kullanarak kolayca şarkı içe aktarabilirsiniz.'),
(1093, '', '', 'imported_a_new_song_', 'Imported a new song,', 'استوردت أغنية جديدة،', 'Importeerde een nieuw nummer,', 'Importé une nouvelle chanson,', 'Ein neues Lied importiert,', 'Импортировал новую песню,', 'Importó una nueva canción,', 'Yeni bir şarkı ithal etti,'),
(1094, '', '', 'review_has_been_sent_successfully', 'Review has been sent successfully!', 'تم إرسال مراجعة بنجاح!', 'Beoordeling is succesvol verzonden!', 'L\'avis a été envoyé avec succès!', 'Die Überprüfung wurde erfolgreich gesendet!', 'Обзор был успешно отправлен!', '¡La revisión ha sido enviada con éxito!', 'İnceleme başarıyla gönderildi!'),
(1095, '', '', 'created_new_product_', 'created new product,', 'خلق منتج جديد،', 'nieuw product gemaakt,', '', 'neues Produkt erstellt,', 'Создан новый продукт,', 'Nuevo producto creado,', 'yeni ürün yaratıldı,'),
(1096, '', '', 'created_new_event_', 'created new event,', 'تم إنشاء حدث جديد،', 'Nieuwe gebeurtenis gemaakt,', 'créé nouvel événement,', 'Neues Ereignis erstellt,', 'Создано новое событие,', 'creado nuevo evento,', 'Yeni olay oluşturuldu,'),
(1097, '', '', 'joined_new_event_', 'joined new event,', 'انضم الحدث الجديد،', 'toegetreden tot een nieuw evenement,', '', 'mit dem neuen Ereignis,', 'присоединился к новому событию,', 'un nuevo evento,', 'Yeni etkinliğe katıldı,'),
(1098, '', '', 'purchased_a_ticket_', 'purchased a ticket,', 'اشترت تذكرة،', 'kocht een ticket,', 'acheté un billet,', 'ein Ticket gekauft,', 'купил билет,', 'compró un boleto,', 'bir bilet satın aldı,'),
(1099, '', '', 'my_store', 'My Store', 'متجري', 'Mijn winkel', 'Mon magasin', 'Mein Laden', 'Мой магазин', 'Mi tienda', 'Benim hikayem'),
(1100, '', '', 'store_analytics', 'Store Analytics', 'تخزين التحليلات', 'Bewaar Analytics', 'Store Analytics', 'Analytik speichern', 'Хранить аналитику', 'Análisis de la tienda', 'Mağaza Analytics'),
(1101, '', '', 'total_products', 'Total Products', 'مجموع المنتجات', 'Totale producten', '', 'Gesamtprodukte', 'Общая продукция', 'Productos totales', 'Toplam Ürünler'),
(1102, '', '', 'total_earned', 'Total Earned', 'إجمالي المكتسبة', 'totaal verdiend', '', 'insgesamt verdient', 'Всего заработало', 'Total de Ganancias', 'Toplam Kazanç'),
(1103, '', '', 'total_commission', 'Total Commission', 'اللجنة الإجمالية', 'Totale commissie', 'Commission totale', 'Total Commission.', 'Общая комиссия', 'Comisión total', 'Toplam Komisyon'),
(1104, '', '', 'total_sub_earned', 'Total Sub Earned', 'مجموع الفرعية المكتسبة', 'Totaal verdiende sub', 'Total submergé', 'Total sub verdient', 'Общая подразделение', 'Total subvendado', 'Toplam Alt Kazanılan'),
(1105, '', '', 'most_sold_products', 'Most sold products', 'الأكثر مبيعا المنتجات', 'Meest verkochte producten', 'Produits les plus vendus', 'Die meisten verkauften Produkte', 'Самые проданные продукты', 'Productos más vendidos', 'En çok satılan ürünler'),
(1106, '', '', 'event_name_can_not_be_empty', 'Event name can not be empty', 'اسم الحدث لا يمكن أن يكون فارغا', 'Evenementnaam kan niet leeg zijn', 'Le nom de l\'événement ne peut pas être vide', 'Ereignisname kann nicht leer sein', 'Имя события не может быть пустым', 'El nombre del evento no puede estar vacío', 'Etkinlik adı boş olamaz'),
(1107, '', '', 'event_description_can_not_be_empty', 'Event description can not be empty', 'وصف الحدث لا يمكن أن يكون فارغا', 'Evenementbeschrijving kan niet leeg zijn', 'Description de l\'événement ne peut pas être vide', 'Ereignisbeschreibung kann nicht leer sein', 'Описание события не может быть пустым', 'La descripción del evento no puede estar vacía', 'Etkinlik Açıklaması boş olamaz'),
(1108, '', '', 'start_date_can_not_be_empty', 'Start date can not be empty', 'تاريخ البدء لا يمكن أن يكون فارغا', 'Startdatum kan niet leeg zijn', 'La date de début ne peut pas être vide', 'Startdatum kann nicht leer sein', 'Дата начала не может быть пустым', 'La fecha de inicio no puede estar vacía', 'Başlangıç ​​Tarihi boş olamaz'),
(1109, '', '', 'create_story', 'Create Story', 'إنشاء قصة', 'Maak een verhaal', 'Créer une histoire', 'Geschichte erstellen', 'Создать историю', 'Crear historia', 'Hikaye yarat'),
(1110, '', '', 'product_related_song_can_not_be_empty', 'Product related song can not be empty', 'أغنية ذات الصلة المنتج لا يمكن أن تكون فارغة', 'Productgerelateerd nummer kan niet leeg zijn', '', 'Produktbedingter Song kann nicht leer sein', 'Соглашенная продукция песня не может быть пустой', 'La canción relacionada con el producto no puede estar vacía', 'Ürünle ilgili şarkı boş olamaz'),
(1111, '', '', 'product_info', 'Product Info', 'معلومات المنتج', 'Product informatie', 'Information sur le produit', 'Produktinformation', 'Информация о продукте', 'Información del producto', 'Ürün bilgisi'),
(1112, '', '', 'event_info', 'event Info', 'معلومات الحدث', 'gebeurtenisinfo', 'Informations sur l\'événement', 'Ereignisinfo.', 'Информация о событии', 'Información del evento', 'olay bilgisi'),
(1113, '', '', 'you_are_not_the_owner', 'You are not the owner', 'أنت لست المالك', 'Jij bent niet de eigenaar', '', 'Du bist nicht der Besitzer', 'Вы не являетесь владельцем', 'Tu no eres el dueño', 'Sen sahibi değilsin'),
(1114, '', '', 'event_not_found', 'Event not found', 'لم يتم العثور على الحدث', 'Gebeurtenis niet gevonden', 'Événement non trouvé', 'Ereignis nicht gefunden', 'Событие не найдено', 'Evento no encontrado', 'Etkinlik bulunamadı'),
(1115, '', '', 'this_event_is_free', 'This event is free', 'هذا الحدث مجاني', 'Dit evenement is gratis', 'Cet événement est gratuit', 'Diese Veranstaltung ist kostenlos', 'Это событие бесплатно', 'Este evento es gratis.', 'Bu etkinlik ücretsizdir'),
(1116, '', '', 'there_is_no_available_tickets', 'There is no available tickets', 'لا توجد تذاكر متاحة', 'Er is geen beschikbare tickets', 'Il n\'y a pas de billets disponibles', 'Es gibt keine verfügbaren Tickets', 'Нет доступных билетов', 'No hay boletos disponibles.', 'Müsait bilet yok'),
(1117, '', '', 'card_is_empty', 'Card is empty', 'البطاقة فارغة', 'Kaart is leeg', 'La carte est vide', 'Karte ist leer', 'Карта пуста', 'La tarjeta esta vacia', 'Kart boş'),
(1118, '', '', 'address_can_not_be_empty', 'Address can not be empty', 'العنوان لا يمكن أن يكون فارغا', 'Adres kan niet leeg zijn', 'L\'adresse ne peut pas être vide', 'Adresse kann nicht leer sein', 'Адрес не может быть пустым', 'La dirección no puede estar vacía', 'Adres boş olamaz'),
(1119, '', '', 'id_can_not_be_empty', 'id can not be empty', 'معرف لا يمكن أن يكون فارغا', 'id kan niet leeg zijn', 'id ne peut pas être vide', 'ID kann nicht leer sein', 'Идентификатор не может быть пустым', 'La identificación no puede estar vacía', 'Kimlik boş olamaz'),
(1120, '', '', 'event_location_can_not_be_empty', 'Event location can not be empty', 'موقع الحدث لا يمكن أن يكون فارغا', 'Evenementlocatie kan niet leeg zijn', 'L\'emplacement de l\'événement ne peut pas être vide', 'Der Ereignisstandort kann nicht leer sein', 'Место события не может быть пустым', 'La ubicación del evento no puede estar vacía', 'Olay yeri boş olamaz'),
(1121, '', '', 'start_time_can_not_be_empty', 'Start time can not be empty', 'وقت البدء لا يمكن أن يكون فارغا', 'Starttijd kan niet leeg zijn', 'Heure de début ne peut pas être vide', 'Startzeit kann nicht leer sein', 'Время начала не может быть пустым', 'La hora de inicio no puede estar vacía', 'Başlangıç ​​zamanı boş olamaz'),
(1122, '', '', 'end_date_can_not_be_empty', 'End Date can not be empty', 'تاريخ الانتهاء لا يمكن أن يكون فارغا', 'Einddatum kan niet leeg zijn', 'La date de fin ne peut pas être vide', 'Enddatum kann nicht leer sein', 'Дата окончания не может быть пустой', 'La fecha de finalización no puede estar vacía', 'Bitiş tarihi boş olamaz'),
(1123, '', '', 'end_time_can_not_be_empty', 'End time can not be empty', 'نهاية الوقت لا يمكن أن تكون فارغة', 'Eindtijd kan niet leeg zijn', 'L\'heure de fin ne peut pas être vide', 'Endzeit kann nicht leer sein', 'Время окончания не может быть пустым', 'El tiempo final no puede estar vacío', 'Son zaman boş olamaz'),
(1124, '', '', 'timezone_can_not_be_empty', 'Timezone can not be empty', 'timezone لا يمكن أن تكون فارغة', 'Timezone kan niet leeg zijn', 'Le fuseau horaire ne peut pas être vide', 'Zeitzone kann nicht leer sein', 'Часовой пояс не может быть пустым', 'TimeZone no puede estar vacío', 'Timezone boş olamaz'),
(1125, '', '', 'event_image_can_not_be_empty', 'Event image can not be empty', 'صورة الحدث لا يمكن أن تكون فارغة', 'Evenementbeeld kan niet leeg zijn', 'L\'image d\'événement ne peut pas être vide', 'Ereignisbild kann nicht leer sein', 'Изображение события не может быть пустым', 'La imagen del evento no puede estar vacía', 'Etkinlik görüntüsü boş olamaz'),
(1126, '', '', 'product_title_can_not_be_empty', 'Product title can not be empty', 'عنوان المنتج لا يمكن أن يكون فارغا', 'Producttitel kan niet leeg zijn', 'Le titre du produit ne peut pas être vide', 'Der Produkttitel kann nicht leer sein', 'Название продукта не может быть пустым', 'El título del producto no puede estar vacío', 'Ürün başlığı boş olamaz'),
(1127, '', '', 'product_description_can_not_be_empty', 'Product description can not be empty', 'وصف المنتج لا يمكن أن يكون فارغا', 'Productbeschrijving kan niet leeg zijn', '', 'Produktbeschreibung kann nicht leer sein', 'Описание продукта не может быть пустым', 'La descripción del producto no puede estar vacía', 'Ürün Açıklaması boş olamaz'),
(1128, '', '', 'product_tags_can_not_be_empty', 'Product tags can not be empty', 'علامات المنتج لا يمكن أن تكون فارغة', 'Producttags kunnen niet leeg zijn', 'Les balises de produit ne peuvent pas être vides', 'Produkt-Tags können nicht leer sein', 'Теги продукта не могут быть пустыми', 'Las etiquetas del producto no pueden estar vacías.', 'Ürün Etiketleri boş olamaz'),
(1129, '', '', 'product_price_can_not_be_empty', 'Product price can not be empty', 'سعر المنتج لا يمكن أن يكون فارغا', 'Productprijs kan niet leeg zijn', 'Le prix du produit ne peut pas être vide', 'Produktpreis kann nicht leer sein', 'Цена продукта не может быть пустой', 'El precio del producto no puede estar vacío', 'Ürün fiyatı boş olamaz'),
(1130, '', '', 'product_units_can_not_be_empty', 'Product units can not be empty', 'وحدات المنتج لا يمكن أن تكون فارغة', 'Producteenheden kunnen niet leeg zijn', 'Les unités de produits ne peuvent pas être vides', 'Produkteinheiten können nicht leer sein', 'Единицы продукта не могут быть пустыми', 'Las unidades de productos no pueden estar vacías.', 'Ürün üniteleri boş olamaz'),
(1131, '', '', 'product_category_can_not_be_empty', 'Product category can not be empty', 'فئة المنتج لا يمكن أن تكون فارغة', 'Productcategorie kan niet leeg zijn', 'La catégorie de produit ne peut pas être vide', 'Produktkategorie kann nicht leer sein', 'Категория продукта не может быть пустой', 'La categoría de producto no puede estar vacía', 'Ürün kategorisi boş olamaz'),
(1132, '', '', 'product_image_can_not_be_empty', 'Product image can not be empty', 'صورة المنتج لا يمكن أن تكون فارغة', 'Productafbeelding kan niet leeg zijn', '', 'Produktbild kann nicht leer sein', 'Изображение продукта не может быть пустым', 'La imagen del producto no puede estar vacía', 'Ürün resmi boş olamaz'),
(1133, '', '', 'product_not_found', 'Product not found', 'الصنف غير موجود', 'product niet gevonden', 'Produit non trouvé', 'Produkt nicht gefunden', 'Продукт не найден', 'Producto no encontrado', 'ürün bulunamadı'),
(1134, '', '', 'address_not_found', 'Address not found', 'لم يتم العثور على العنوان', 'Adres niet gevonden', 'Adresse introuvable', 'Adresse nicht gefunden', 'Адрес не найден', 'Dirección no encontrada', 'Adres bulunamadı'),
(1135, '', '', 'tracking_url_can_not_be_empty', 'Tracking url can not be empty', 'لا يمكن أن يكون تتبع عنوان URL فارغا', 'Tracking-URL kan niet leeg zijn', 'L\'URL de suivi ne peut pas être vide', 'Tracking-URL kann nicht leer sein', 'УРЛ отслеживания не может быть пустым', 'La URL de seguimiento no puede estar vacía', 'İzleme URL\'si boş olamaz'),
(1136, '', '', 'tracking_number_can_not_be_empty', 'Tracking number can not be empty', 'عدد تتبع لا يمكن أن يكون فارغا', 'Tracking-nummer kan niet leeg zijn', 'Le numéro de suivi ne peut pas être vide', 'Die Tracking-Nummer kann nicht leer sein', 'Номер отслеживания не может быть пустым', 'El número de seguimiento no puede estar vacío', 'İzleme numarası boş olamaz'),
(1137, '', '', 'please_enter_a_valid_url', 'Please enter a valid url', 'أدخل رابط صحيح من فضلك', 'Voer een geldige URL in', 'S\'il vous plaît entrer une URL valide', 'Bitte geben Sie eine gültige URL ein', 'Пожалуйста, введите корректный адрес', 'Por favor introduzca un URL válido', 'Lütfen geçerli bir adres girin'),
(1138, '', '', 'rating_can_not_be_empty', 'rating can not be empty', 'التصنيف لا يمكن أن يكون فارغا', 'beoordeling kan niet leeg zijn', 'la note ne peut pas être vide', 'Bewertung kann nicht leer sein', 'Рейтинг не может быть пустым', 'la calificación no puede estar vacía', 'derecelendirme boş olamaz'),
(1139, '', '', 'review_can_not_be_empty', 'review can not be empty', 'مراجعة لا يمكن أن تكون فارغة', 'beoordeling kan niet leeg zijn', 'la revue ne peut pas être vide', 'Überprüfung kann nicht leer sein', 'Обзор не может быть пустым', 'La revisión no puede estar vacía', 'İnceleme boş olamaz'),
(1140, '', '', 'please_who_can_see_the_story', 'Please who can see the story', 'من فضلك من يستطيع رؤية القصة', 'Alsjeblieft wie het verhaal kan zien', 'S\'il vous plaît qui peut voir l\'histoire', 'Bitte, wer kann die Geschichte sehen?', 'Пожалуйста, кто может видеть историю', 'Por favor, quien puede ver la historia', 'Lütfen hikayeyi kim görebilir'),
(1141, '', '', 'please_select_a_story_image', 'Please select a story image', '', 'Selecteer een verhaalbeeld', 'S\'il vous plaît sélectionnez une image de l\'histoire', 'Bitte wählen Sie ein Story-Image aus', 'Пожалуйста, выберите историю изображения', 'Por favor, seleccione una imagen de historia', 'Lütfen bir hikaye görüntüsü seçin'),
(1142, '', '', 'please_select_a_story_song', 'Please select a story song', 'يرجى اختيار أغنية قصة', '', '', 'Bitte wählen Sie ein Story-Song aus', 'Пожалуйста, выберите историю песни', 'Por favor seleccione una canción de historia', 'Lütfen bir hikaye şarkısı seçin'),
(1143, '', '', 'story_not_found_or_its_not_active', 'Story not found or its not active', 'القصة غير موجودة أو غير نشطة', 'Verhaal niet gevonden of het is niet actief', 'Histoire non trouvée ou elle n\'est pas active', 'Geschichte nicht gefunden oder nicht aktiv', 'История не найдена или не активна', 'La historia no se encuentra o no está activa.', 'Hikaye bulunamadı ya da aktif değil'),
(1144, '', '', 'get_verified', 'Get verified', '', '', 'Être vérifié', 'Verifiziert werden', 'Пройти проверку', 'Verifícate', 'Onaylanmış olmak'),
(1145, '', '', 'sell_your_songs', 'sell your songs', '', 'Verkoop je liedjes', 'Vendre vos chansons', 'Verkaufen Sie Ihre Songs.', 'Продайте свои песни', 'Vende tus canciones', 'şarkılarını sat'),
(1146, '', '', 'sell_products', 'sell products', 'بيع المنتجات', 'producten verkopen', 'vendez des produits', 'Produkte verkaufen', 'продавать продукты', 'Vender productos', 'Ürünleri sat');
INSERT INTO `langs` (`id`, `ref`, `options`, `lang_key`, `english`, `arabic`, `dutch`, `french`, `german`, `russian`, `spanish`, `turkish`) VALUES
(1147, '', '', 'create_events_and_sell_tickets', 'Create events and sell tickets', '', '', 'Créer des événements et vendre des billets', 'Erstellen Sie Events und verkaufen Sie Tickets', 'Создание мероприятий и продажи билетов', 'Crear eventos y vender boletos', 'Etkinlikler oluşturun ve bilet satmak'),
(1148, '', '', 'upload_more_songs', 'upload more songs', 'تحميل المزيد من الأغاني', '', 'Télécharger plus de chansons', 'Laden Sie mehr Songs hoch', 'Загрузить больше песен', 'Sube más canciones', 'Daha fazla şarkı yükle'),
(1149, '', '', 'get_more_space', 'get more space', '', '', 'obtenir plus d\'espace', 'mehr Platz bekommen.', 'получить больше места', 'obtener más espacio', 'daha fazla yer al'),
(1150, '', '', 'get_a_special_looking_profile_and_get_famous_on_our_platform_', 'get a special looking profile and get famous on our platform!', '', '', '', 'Holen Sie sich ein spezielles Profil und berühmt auf unserer Plattform!', 'Получите специальный поиск профиль и получите знаменитую на нашей платформе!', '¡Obtén un perfil especial y hazte famoso en nuestra plataforma!', 'Özel görünümlü bir profil alın ve platformumuzda ünlü olun!'),
(1151, '', '', 'ticket_was_purchased_in_sitename__date', 'Ticket was purchased in {SITENAME}, {DATE}', 'تم شراء تذكرة في {SITENAME}، {DATE}', '', 'Le billet a été acheté dans {SITENAME}, {DATE}', 'Das Ticket wurde in {SITENAME} erworben, {DATE}', 'Билет был куплен в {SITENAME}, {DATE}', 'El boleto fue comprado en {SITENAME}, {DATE}', 'Bilet {SITENAME}, {DATE} \'de satın alındı.'),
(1152, '', '', 'created_new_product', 'Created new product', '', '', 'Nouveau produit créé', 'Neues Produkt erstellt', 'Создан новый продукт', 'Creado nuevo producto', 'Yeni ürün oluşturdu'),
(1153, '', '', 'track', 'Track', '', '', 'Pister', 'Spur', 'Отслеживать', 'Pista', 'İzlemek'),
(1154, '', '', 'event_ticket', 'Event Ticket', '', '', 'Billet d\'événement', 'Event-Ticket', 'Билет событий', 'Billete de eventos', 'Olay bileti'),
(1155, '', '', 'for', 'For', 'ل', '', 'Pour', 'Zum', 'Для', 'Para', 'İçin'),
(1156, '', '', 'event_starts', 'Event Starts', 'يبدأ الحدث', '', 'Événement commence', 'Veranstaltung beginnt.', 'Событие начинается', 'Evento comienza', 'Etkinlik başlar'),
(1157, '', '', 'event_ends', 'Event Ends', 'ينتهي الحدث', '', 'Se termine', 'Ereignis endet', 'Событие заканчивается', 'Evento termina', 'Olay biter'),
(1158, '', '', 'video_duration_must_be_less_than_or_equal_10_seconds', 'Video duration must be less than or equal 10 seconds', '', 'Video Duur moet minder zijn dan of gelijk aan 10 seconden', 'La durée de la vidéo doit être inférieure ou égale 10 secondes', 'Die Videodauer muss weniger als 10 Sekunden betragen', 'Продолжительность видео должна быть меньше или равна 10 секунд', 'La duración del video debe ser menor o igual de 10 segundos.', 'Video süresi 10 saniyeden az veya eşit olmalıdır'),
(1159, '', '', 'purchased_by', 'Purchased By', '', '', 'Acheté par', 'Erworben von', 'Куплен', 'Comprado por', 'Tarafından satın alındı'),
(1160, '', '', 'event_address', 'Event Address', 'عنوان الحدث', '', 'Adresse d\'événement', 'Ereignisadresse', 'Адрес событий', 'Dirección del evento', 'Olay adresi'),
(1161, '', '', 'no_more_orders_found', 'No more orders found', '', '', 'Plus de commandes trouvées', 'Keine Bestellungen mehr gefunden', 'Больше не найдено заказов', 'No se han encontrado más pedidos', 'Daha fazla sipariş bulunamadı'),
(1162, '', '', 'login_to_purchase', 'Login To Purchase', '', '', '', 'Melden Sie sich beim Kauf an', 'Войти в покупку', 'Inicia sesión para comprar', 'Satın almak için giriş yapın'),
(1163, '', '', 'your_video_will_be_converted_to_mp3_soon__you_ll_get_notified_once_imported', 'Your video will be converted to mp3 soon, youll get notified once imported', '', 'Uw video wordt binnenkort geconverteerd naar MP3, u ontvangt eenmaal eenmaal geïmporteerd', 'Votre vidéo sera convertie en mp3 prochainement, vous serez notifié une fois importé', 'Ihr Video wird in Kürze in MP3 umgewandelt, Sie werden einmal mit dem Import benachrichtigt', 'Ваше видео будет преобразовано в MP3 в ближайшее время, вы получите уведомление после импорта', 'Su video se convertirá a MP3 pronto, recibirá notificado una vez importado', 'Videonuz yakında MP3\'e dönüştürülecek, bir kez ithal edilecek'),
(1164, '', '', 'your_song_is_ready_to_view', 'your song is ready to view', 'أغنيتك جاهزة للعرض', 'je nummer is klaar om te bekijken', 'votre chanson est prête à voir', 'Ihr Lied ist bereit zu sehen', 'Ваша песня готова к просмотру', 'Tu canción está lista para ver', 'Şarkınız görüntülenmeye hazır'),
(1165, '', '', 'points', 'Points', 'نقاط', 'Punten', 'Points', 'Punkte', 'Точки', 'Puntos', 'Puan'),
(1166, '', '', 'points_on_listening_to_a_song.', 'Points on listening to a song.', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(1167, '', '', 'your_earned_points_will_automatically_go_to', 'Your earned points will automatically go to', 'سوف تذهب نقاطك المكتسبة تلقائيا إلى', 'Uw verdiende punten gaan automatisch naar', 'Vos points gagnés vont automatiquement aller automatiquement à', 'Ihre verdienten Punkte werden automatisch angehoben', 'Ваши заработанные очки автоматически перейдут', 'Sus puntos ganados irán automáticamente a', 'Kazanılan puanlarınız otomatik olarak gidilir'),
(1168, '', '', 'earn_points', 'Earn Points', 'اكسب النقاط', 'Verdien punten', 'Gagnez des points', 'Verdiene Punkte', 'Зарабатывайте очки', 'Gana puntos', 'Puan Kazanın');
...
INSERT INTO `products_category` (`id`, `lang_key`) VALUES
(2, 's_clothes'),
(3, 's_electronic'),
(1, 's_other');
...
ALTER TABLE `events`
  ...
  ADD KEY `available_tickets` (`available_tickets`),
...
--
-- Indexes for table `events_joined`
--
ALTER TABLE `events_joined`
  ADD PRIMARY KEY (`id`),
  ADD KEY `event_id` (`event_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `time` (`time`);
...
ALTER TABLE `products`
  ...
  ADD KEY `user_id` (`user_id`),
  ADD KEY `price` (`price`),
  ADD KEY `related_song` (`related_song`),
  ADD KEY `active` (`active`),
  ADD KEY `units` (`units`),
  ADD KEY `hash_id` (`hash_id`),
...
ALTER TABLE `story_seen`
  ...
  ADD KEY `paid` (`paid`),
  ADD KEY `time` (`time`),
  ADD KEY `story_owner_id` (`story_owner_id`),
  ADD KEY `fingerPrint` (`fingerPrint`);
...
ALTER TABLE `users`
  ...
  ADD KEY `time` (`time`),
  ADD KEY `time_code_sent` (`time_code_sent`),
...
--
-- AUTO_INCREMENT for table `events_joined`
--
ALTER TABLE `events_joined`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
